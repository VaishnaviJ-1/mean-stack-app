...
<title>My Project: @npmcli/git</title>
...
<li><code>cwd</code> The current working dir for the git command. Particularly for <code>find</code> and <code>is</code> and <code>isClean</code>, it's good to know that this defaults to <code>process.cwd()</code>, as one might expect.</li>
