...
<title>My Project: json-ext</title>
...
<div><div class="header">
  <div class="headertitle"><div class="title">json-ext </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p ><a href="https://www.npmjs.com/package/@discoveryjs/json-ext"><img src="https://img.shields.io/npm/v/@discoveryjs/json-ext.svg" alt="NPM version" style="pointer-events: none;" class="inline"/></a> <a href="https://travis-ci.org/discoveryjs/json-ext"><img src="https://travis-ci.org/discoveryjs/json-ext.svg?branch=master" alt="Build Status" style="pointer-events: none;" class="inline"/></a> <a href="https://coveralls.io/github/discoveryjs/json-ext?"><img src="https://coveralls.io/repos/github/discoveryjs/json-ext/badge.svg?branch=master" alt="Coverage Status" style="pointer-events: none;" class="inline"/></a> <a href="https://www.npmjs.com/package/@discoveryjs/json-ext"><img src="https://img.shields.io/npm/dm/@discoveryjs/json-ext.svg" alt="NPM Downloads" style="pointer-events: none;" class="inline"/></a></p>
<p >A set of utilities that extend the use of JSON. Designed to be fast and memory efficient</p>
<p >Features:</p>
<ul>
<li>[x] <code>parseChunked()</code> – Parse JSON that comes by chunks (e.g. FS readable stream or fetch response stream)</li>
<li>[x] <code>stringifyStream()</code> – Stringify stream (Node.js)</li>
<li>[x] <code>stringifyInfo()</code> – Get estimated size and other facts of JSON.stringify() without converting a value to string</li>
<li>[ ] <b>TBD</b> Support for circular references</li>
<li>[ ] <b>TBD</b> Binary representation <a href="https://github.com/discoveryjs/json-ext/tree/binary">branch</a></li>
<li>[ ] <b>TBD</b> WHATWG <a href="https://streams.spec.whatwg.org/">Streams</a> support</li>
</ul>
<h1><a class="anchor" id="autotoc_md1174"></a>
Install</h1>
<div class="fragment"><div class="line">npm install @discoveryjs/json-ext</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md1175"></a>
API</h1>
<ul>
...
<p >&zwj;NOTE: <code>reviver</code> parameter is not supported yet, but will be added in next releases. NOTE: WHATWG streams aren't supported yet </p>
</blockquote>
<p>When to use:</p><ul>
...
<div class="line">        /* data is parsed JSON */</div>
<div class="line">    })</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1177"></a>
...
<blockquote class="doxtable">
<p >&zwj;NOTE: WHATWG Streams aren't supported yet, so function available for Node.js only for now </p>
</blockquote>
...
<h4><a class="anchor" id="autotoc_md1181"></a>
