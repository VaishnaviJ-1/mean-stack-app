...
<title>My Project: Description</title>
...
LifeCycle</h1>
<p >A <code>Job</code> goes through multiple LifeCycle messages before its completion;</p>
<ol type="1">
<li><code>JobState.Queued</code>. The job was queued and is waiting. This is the default state from the scheduler.</li>
</ol>
<ol type="1">
<li><code>JobState.Ready</code>. The job's dependencies (see &quot;Synchronizing and Dependencies&quot;) are done running, the argument is validated, and the job is ready to execute.</li>
</ol>
<ol type="1">
...
<ol type="1">
<li><code>inboundBus</code>. The raw input <code>Observer&lt;JobInboundMessage&gt;</code>. This can be used to send messages to the <code>context.inboundBus</code> observable in the job. These are <code>JobInboundMessage</code> messages. See &quot;Communicating With Jobs&quot;.</li>
</ol>
<ol type="1">
<li><code>outboundBus</code>. The raw output <code>Observable&lt;JobOutput&gt;</code>. This can be used to listen to messages from the job. See &quot;Communicating With Jobs&quot;.</li>
</ol>
...
<div class="line"> </div>
<div class="line">const add = jobs.createJobHandle&lt;number[], number&gt;((input) =&gt;</div>
<div class="line">  input.reduce((total, curr) =&gt; total + curr, 0),</div>
<div class="line">);</div>
<div class="line"> </div>
...
<div class="line">  .schedule(&#39;add&#39;, [1, 2, 3, 4])</div>
<div class="line">  .promise.then((output) =&gt; console.log(&#39;1 + 2 + 3 + 4 is &#39; + output));</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md319"></a>
Creating Jobs</h1>
...
<div class="line">scheduler.schedule(&#39;add&#39;, [1, 2, 3, 4]).output.subscribe((x) =&gt; console.log(x)); // Will output 10.</div>
...
<div class="line">export const add = jobs.createJobHandler&lt;number[], number&gt;((argument) =&gt;</div>
<div class="line">  argument.reduce((total, curr) =&gt; total + curr, 0),</div>
<div class="line">);</div>
<div class="line"> </div>
...
<div class="line">  (argument: number, { createChannel }) =&gt;</div>
<div class="line">    new Observable&lt;number&gt;((o) =&gt; {</div>
...
<div class="line">  .getChannel&lt;number&gt;(&#39;progress&#39;, { type: &#39;number&#39; })</div>
...
<div class="line">  jobs.createJobHandler&lt;number[], number&gt;((argument) =&gt;</div>
<div class="line">    argument.reduce((total, curr) =&gt; total + curr, 0),</div>
<div class="line">  ),</div>
<div class="line">);</div>
...
<div class="fragment"><div class="line">import { jobs } from &#39;@angular-devkit/core&#39;;</div>
<div class="line"> </div>
<div class="line">const add = jobs.createJobHandler&lt;number[], number&gt;((argument) =&gt;</div>
<div class="line">  argument.reduce((total, curr) =&gt; total + curr, 0),</div>
<div class="line">);</div>
<div class="line"> </div>
<div class="line">// Register the job in a SimpleJobRegistry. Different registries have different API.</div>
