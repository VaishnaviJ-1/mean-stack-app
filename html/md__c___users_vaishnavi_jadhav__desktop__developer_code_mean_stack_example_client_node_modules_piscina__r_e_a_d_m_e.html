...
<div class="contents">
<div class="textblock"><p ><img src="https://avatars1.githubusercontent.com/u/65627548?s=200&amp;v=4" alt="Piscina Logo" class="inline"/></p>
<h1><a class="anchor" id="autotoc_md10249"></a>
...
<p >For Node.js 12.x and higher.</p>
<p >MIT Licensed.</p>
<h2><a class="anchor" id="autotoc_md10250"></a>
Piscina API</h2>
<h3><a class="anchor" id="autotoc_md10251"></a>
Example</h3>
...
<div class="fragment"><div class="line">const { promisify } = require(&#39;util&#39;);</div>
<div class="line"> </div>
<div class="line">// Awaitable timers are available in Node.js 15.x+</div>
<div class="line">// For Node.js 12 and 14, use promisify(setTimeout)</div>
<div class="line">const { setTimeout } = require(&#39;timers/promises&#39;);</div>
<div class="line"> </div>
...
<div class="line">  return a + b;</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10252"></a>
...
<div class="line">  ]);</div>
<div class="line">})();</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10253"></a>
Cancelable Tasks</h3>
...
<div class="line">  });</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10256"></a>
Additional Examples</h3>
<p >Additional examples can be found in the GitHub repo at <a href="https://github.com/jasnell/piscina/tree/master/examples">https://github.com/jasnell/piscina/tree/master/examples</a></p>
<h2><a class="anchor" id="autotoc_md10257"></a>
Class: &lt;tt&gt;Piscina&lt;/tt&gt;</h2>
...
Constructor: &lt;tt&gt;new Piscina([options])&lt;/tt&gt;</h3>
<ul>
...
<li><code>name</code>: (<code>string | null</code>) Provides the name of the default exported worker function. The default is &lsquo;'default&rsquo;`, indicating the default export of the worker module.</li>
<li><code>minThreads</code>: (<code>number</code>) Sets the minimum number of threads that are always running for this thread pool. The default is based on the number of available CPUs.</li>
<li><code>maxThreads</code>: (<code>number</code>) Sets the maximum number of threads that are running for this thread pool. The default is based on the number of available CPUs.</li>
<li><code>idleTimeout</code>: (<code>number</code>) A timeout in milliseconds that specifies how long a <code>Worker</code> is allowed to be idle, i.e. not handling any tasks, before it is shut down. By default, this is immediate. <b>Tip</b>: <em>The default <code>idleTimeout</code> can lead to some performance loss in the application because of the overhead involved with stopping and starting new worker threads. To improve performance, try setting the <code>idleTimeout</code> explicitly.</em></li>
<li><code>maxQueue</code>: (<code>number</code> | <code>string</code>) The maximum number of tasks that may be scheduled to run, but not yet running due to lack of available threads, at a given time. By default, there is no limit. The special value &lsquo;'auto&rsquo;<code> may be used to have Piscina calculate the maximum as the square of</code>maxThreads<code>. When</code>'auto'<code>is used, the calculated</code>maxQueue<code>value may be found by checking the [</code>options.maxQueue<code>](#property-options-readonly) property. *</code>concurrentTasksPerWorker<code>: (</code>number<code>) Specifies how many tasks can share a single Worker thread simultaneously. The default is</code>1`. This generally only makes sense to specify if there is some kind of asynchronous component to the task. Keep in mind that Worker threads are generally not built for handling I/O in parallel.</li>
<li><code>useAtomics</code>: (<code>boolean</code>) Use the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Atomics"><code>Atomics</code></a> API for faster communication between threads. This is on by default. You can disable <code>Atomics</code> globally by setting the environment variable <code>PISCINA_DISABLE_ATOMICS</code> to <code>1</code>.</li>
<li><code>resourceLimits</code>: (<code>object</code>) See <a href="https://nodejs.org/api/worker_threads.html#worker_threads_new_worker_filename_options">Node.js new Worker options</a><ul>
<li><code>maxOldGenerationSizeMb</code>: (<code>number</code>) The maximum size of each worker threads main heap in MB.</li>
<li><code>maxYoungGenerationSizeMb</code>: (<code>number</code>) The maximum size of a heap space for recently created objects.</li>
<li><code>codeRangeSizeMb</code>: (<code>number</code>) The size of a pre-allocated memory range used for generated code.</li>
<li><code>stackSizeMb</code> : (<code>number</code>) The default maximum stack size for the thread. Small values may lead to unusable Worker instances. Default: 4</li>
</ul>
</li>
<li><code>env</code>: (<code>object</code>) If set, specifies the initial value of <code>process.env</code> inside the worker threads. See <a href="https://nodejs.org/api/worker_threads.html#worker_threads_new_worker_filename_options">Node.js new Worker options</a> for details.</li>
<li><code>argv</code>: (<code>any[]</code>) List of arguments that will be stringified and appended to <code>process.argv</code> in the worker. See <a href="https://nodejs.org/api/worker_threads.html#worker_threads_new_worker_filename_options">Node.js new Worker options</a> for details.</li>
<li><code>execArgv</code>: (<code>string[]</code>) List of Node.js CLI options passed to the worker. See <a href="https://nodejs.org/api/worker_threads.html#worker_threads_new_worker_filename_options">Node.js new Worker options</a> for details.</li>
<li><code>workerData</code>: (<code>any</code>) Any JavaScript value that can be cloned and made available as &lsquo;require('piscina&rsquo;).workerData<code>. See [Node.js new Worker options][] for details. Unlike regular Node.js Worker Threads,</code>workerData<code>must not specify any value requiring a</code>transferList<code>. This is because the</code>workerData` will be cloned for each pooled worker.</li>
<li><code>taskQueue</code>: (<code>TaskQueue</code>) By default, Piscina uses a first-in-first-out queue for submitted tasks. The <code>taskQueue</code> option can be used to provide an alternative implementation. See Custom Task Queues for additional detail.</li>
<li><code>niceIncrement</code>: (<code>number</code>) An optional value that decreases priority for the individual threads, i.e. the higher the value, the lower the priority of the Worker threads. This value is only used on Linux and requires the optional <a href="https://npmjs.org/package/nice-napi"><code>nice-napi</code></a> module to be installed. See <a href="https://linux.die.net/man/2/nice"><code>nice(2)</code></a> for more details.</li>
<li><code>trackUnmanagedFds</code>: (<code>boolean</code>) An optional setting that, when <code>true</code>, will cause Workers to track file descriptors managed using <code>fs.open()</code> and <code>fs.close()</code>, and will close them automatically when the Worker exits. Defaults to <code>true</code>. (This option is only supported on Node.js 12.19+ and all Node.js versions higher than 14.6.0).</li>
</ul>
</li>
</ul>
...
<h3><a class="anchor" id="autotoc_md10259"></a>
Method: &lt;tt&gt;run(task[, options])&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md10260"></a>
Method: &lt;tt&gt;runTask(task[, transferList][, filename][, abortSignal])&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md10262"></a>
Event: ‘'error’`</h3>
...
Property: &lt;tt&gt;options&lt;/tt&gt; (readonly)</h3>
...
Property: &lt;tt&gt;runTime&lt;/tt&gt; (readonly)</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10268"></a>
Property: &lt;tt&gt;threads&lt;/tt&gt; (readonly)</h3>
<p >An Array of the <code>Worker</code> instances used by this pool.</p>
<h3><a class="anchor" id="autotoc_md10269"></a>
Property: &lt;tt&gt;queueSize&lt;/tt&gt; (readonly)</h3>
<p >The current number of tasks waiting to be assigned to a Worker thread.</p>
<h3><a class="anchor" id="autotoc_md10270"></a>
Property: &lt;tt&gt;utilization&lt;/tt&gt; (readonly)</h3>
...
Property: &lt;tt&gt;waitTime&lt;/tt&gt; (readonly)</h3>
...
<div class="line">  p99_999: 1882</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10272"></a>
Static property: &lt;tt&gt;isWorkerThread&lt;/tt&gt; (readonly)</h3>
...
<h4><a class="anchor" id="autotoc_md10275"></a>
Interface: &lt;tt&gt;Transferable&lt;/tt&gt;</h4>
...
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10276"></a>
...
<h2><a class="anchor" id="autotoc_md10277"></a>
Current Limitations (Things we're working on / would love help with)</h2>
<ul>
<li>Improved Documentation</li>
<li>Benchmarks</li>
</ul>
<h2><a class="anchor" id="autotoc_md10278"></a>
...
<h3><a class="anchor" id="autotoc_md10282"></a>
...
<h2><a class="anchor" id="autotoc_md10283"></a>
Release Notes</h2>
<h3><a class="anchor" id="autotoc_md10284"></a>
3.2.0</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md10285"></a>
3.1.0</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md10293"></a>
1.4.0</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md10294"></a>
1.3.0</h3>
<ul>
<li>Added the &lsquo;'drain&rsquo;` event</li>
</ul>
<h3><a class="anchor" id="autotoc_md10295"></a>
1.2.0</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md10296"></a>
1.1.0</h3>
<ul>
<li>Added support for Worker Thread <code>resourceLimits</code></li>
</ul>
<h3><a class="anchor" id="autotoc_md10297"></a>
1.0.0</h3>
<ul>
<li>Initial release!</li>
</ul>
<h2><a class="anchor" id="autotoc_md10298"></a>
The Team</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md10299"></a>
Acknowledgements</h2>
