...
</div><!-- fragment --><p >See below for an example of use with fastify.</p>
...
<td class="markdownTableBodyCenter">**<a class="el" href="md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_inquirer__r_e_a_d_m_e.html#methods">`methods`</a>**   </td><td class="markdownTableBodyCenter"><code>Array</code>   </td><td class="markdownTableBodyCenter">&lsquo;[ 'GET&rsquo;, 'HEAD' ]<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Allows to pass the list of HTTP request methods accepted by the middleware \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowEven"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>headers<code>](#headers)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Array|Object|Function<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>undefined<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Allows to pass custom HTTP headers on each request. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowOdd"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>index<code>](#index)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Boolean|String<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>index.html<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; If</code>false<code>(but not</code>undefined<code>), the server will not respond to requests to the root URL. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowEven"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>mimeTypes<code>](#mimetypes)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Object<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>undefined<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Allows to register custom mime types or extension mappings. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowOdd"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>publicPath<code>](#publicpath)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>String<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>output.publicPath&lt;tt&gt;(from a configuration) \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; The public path that the middleware is bound to. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowEven"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[stats<code>](#stats)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Boolean|String|Object<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>stats&lt;tt&gt;(from a configuration) \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Stats options object or preset name. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowOdd"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[serverSideRender<code>](#serversiderender)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Boolean<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>undefined<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Instructs the module to enable or disable the server-side rendering mode. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowEven"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>writeToDisk<code>](#writetodisk)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Boolean|Function<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>false<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyLeft"&gt; Instructs the module to write files to the configured location on disk as specified in your</code>webpack<code>configuration. \ilinebr &lt;/td&gt; &lt;/tr&gt; &lt;tr class="markdownTableRowOdd"&gt; &lt;td class="markdownTableBodyCenter"&gt; **[</code>outputFileSystem<code>](#outputfilesystem)** \ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt;</code>Object<code>\ilinebr &lt;/td&gt; &lt;td class="markdownTableBodyCenter"&gt; [</code>memfs`](<a href="https://github.com/streamich/memfs">https://github.com/streamich/memfs</a>)   </td><td class="markdownTableBodyLeft">Set the default file system which will be used by webpack as primary destination of generated files.   </td></tr>
</table>
<p >The middleware accepts an <code>options</code> Object. The following is a property reference for the Object.</p>
<h3><a class="anchor" id="autotoc_md15359"></a>
methods</h3>
...
<h3><a class="anchor" id="autotoc_md15360"></a>
headers</h3>
...
<div class="line">  },</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15361"></a>
index</h3>
...
<h3><a class="anchor" id="autotoc_md15362"></a>
mimeTypes</h3>
...
<h3><a class="anchor" id="autotoc_md15363"></a>
publicPath</h3>
...
<h3><a class="anchor" id="autotoc_md15364"></a>
stats</h3>
...
<h3><a class="anchor" id="autotoc_md15365"></a>
serverSideRender</h3>
...
<h3><a class="anchor" id="autotoc_md15366"></a>
writeToDisk</h3>
...
<div class="line">  },</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15367"></a>
outputFileSystem</h3>
<p >Type: <code>Object</code> <br  />
 Default: <a href="https://github.com/streamich/memfs">memfs</a></p>
<p >Set the default file system which will be used by webpack as primary destination of generated files. This option isn't affected by the writeToDisk option.</p>
...
<h3><a class="anchor" id="autotoc_md15369"></a>
...
Parameters</h4>
<p ><a class="anchor" id="autotoc_md15371"></a> </p><h5><code>callback</code></h5>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15372"></a>
...
<h4><a class="anchor" id="autotoc_md15373"></a>
Parameters</h4>
<p ><a class="anchor" id="autotoc_md15374"></a> </p><h5><code>callback</code></h5>
<p >Type: <code>Function</code> Required: <code>No</code></p>
...
<div class="line">}, 1000);</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15375"></a>
...
<h4><a class="anchor" id="autotoc_md15376"></a>
Parameters</h4>
<p ><a class="anchor" id="autotoc_md15377"></a> </p><h5><code>callback</code></h5>
<p >Type: <code>Function</code> Required: <code>No</code></p>
...
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15378"></a>
&lt;tt&gt;getFilenameFromUrl(url)&lt;/tt&gt;</h3>
<p >Get filename from URL.</p>
<h4><a class="anchor" id="autotoc_md15379"></a>
Parameters</h4>
<p ><a class="anchor" id="autotoc_md15380"></a> </p><h5><code>url</code></h5>
...
Known Issues</h2>
<h3><a class="anchor" id="autotoc_md15382"></a>
...
<div class="line">  const { devMiddleware } = res.locals.webpack;</div>
<div class="line">  const outputFileSystem = devMiddleware.context.outputFileSystem;</div>
<div class="line">  const jsonWebpackStats = devMiddleware.context.stats.toJson();</div>
<div class="line">  const { assetsByChunkName, outputPath } = jsonWebpackStats;</div>
<div class="line"> </div>
<div class="line">  // Then use `assetsByChunkName` for server-side rendering</div>
...
<div class="line">      .map((path) =&gt; outputFileSystem.readFileSync(path.join(outputPath, path)))</div>
<div class="line">      .join(&quot;\n&quot;)}</div>
<div class="line">    &lt;/style&gt;</div>
<div class="line">  &lt;/head&gt;</div>
...
<div class="line">  `);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md15384"></a>
Support</h2>
...
<h3><a class="anchor" id="autotoc_md15386"></a>
Fastify</h3>
...
<div class="fragment"><div class="line">const fastify = require(&quot;fastify&quot;)();</div>
<div class="line">const webpack = require(&quot;webpack&quot;);</div>
...
<p >CONTRIBUTING</p>
<h2><a class="anchor" id="autotoc_md15388"></a>
License</h2>
