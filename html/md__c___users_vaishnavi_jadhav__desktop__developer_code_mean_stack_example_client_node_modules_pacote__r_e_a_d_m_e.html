...
<div><div class="header">
  <div class="headertitle"><div class="title">pacote </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p >Fetches package manifests and tarballs from the npm registry.</p>
<h1><a class="anchor" id="autotoc_md9998"></a>
USAGE</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10000"></a>
API</h1>
...
<li><code>log</code> A logger object with methods for various log levels. Typically, this will be <a href="http://npm.im/npmlog"><code>npmlog</code></a> in the npm CLI use case, but if not specified, the default is a logger that emits &lsquo;'log&rsquo;<code>events on the</code>process<code>object. *</code>preferOnline<code>Prefer to revalidate cache entries, even when it would not be strictly necessary. Default</code>false<code>. *</code>before<code>When picking a manifest from a packument, only consider packages published before the specified date. Default</code>null<code>. *</code>defaultTag<code>The default</code>dist-tag<code>to use when choosing a manifest from a packument. Defaults to</code>latest<code>. *</code>registry<code>The npm registry to use by default. Defaults to </code><a href="https://registry.npmjs.org/">https://registry.npmjs.org/</a><code>. *</code>fullMetadata` Fetch the full metadata from the registry for packuments, including information not strictly required for installation (author, description, etc.) Defaults to <code>true</code> when <code>before</code> is set, since the version publish time is part of the extended packument metadata.</li>
...
<h2><a class="anchor" id="autotoc_md10002"></a>
Advanced API</h2>
...
<li><code>npm-signature</code> A signature of the package by the <a href="https://keybase.io/npmregistry"><code>npmregistry</code></a> Keybase account. (Obviously only present for packages published to <code><a href="https://registry.npmjs.org">https://registry.npmjs.org</a></code>.)</li>
</ul>
</li>
</ul>
