...
<title>My Project: http-proxy-middleware</title>
...
⚠️ Note</h1>
<p >This page is showing documentation for version v1.x.x (<a href="https://github.com/chimurai/http-proxy-middleware/releases">release notes</a>)</p>
...
<div class="line"> </div>
<div class="line">// http://localhost:3000/api/foo/bar -&gt; http://www.example.org/api/foo/bar</div>
</div><!-- fragment --><p ><em>All</em> <code>http-proxy</code> <a href="https://github.com/nodejitsu/node-http-proxy#options">options</a> can be used, along with some extra <code>http-proxy-middleware</code> <a class="el" href="md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_forge__r_e_a_d_m_e.html#options">options</a>.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6121"></a>
Core concept</h1>
<p >Proxy middleware configuration.</p>
<h3><a class="anchor" id="autotoc_md6122"></a>
...
<p >(full list of <a class="el" href="md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_forge__r_e_a_d_m_e.html#options">`http-proxy-middleware` configuration options</a>)</p>
<h3><a class="anchor" id="autotoc_md6123"></a>
...
<h2><a class="anchor" id="autotoc_md6129"></a>
...
<li><b>option.headers</b>: object, adds <a href="https://en.wikipedia.org/wiki/List_of_HTTP_header_fields#Request_fields">request headers</a>. (Example: &lsquo;{host:'www.example.org&rsquo;}`)</li>
...
<li><p class="startli"><b>option.buffer</b>: stream of data to send as the request body. Maybe you have some middleware that consumes the request stream before proxying it on e.g. If you read the body of a request into a field called 'req.rawbody' you could restream this field in the buffer option:</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6131"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6133"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6134"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6135"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6140"></a>
Changelog</h1>
<ul>
