...
<div><div class="header">
  <div class="headertitle"><div class="title">ssri <a href="https://npm.im/ssri"><img src="https://img.shields.io/npm/v/ssri.svg" alt="npm version" style="pointer-events: none;" class="inline"/></a> <a href="https://npm.im/ssri"><img src="https://img.shields.io/npm/l/ssri.svg" alt="license" style="pointer-events: none;" class="inline"/></a> <a href="https://travis-ci.org/npm/ssri"><img src="https://img.shields.io/travis/npm/ssri.svg" alt="Travis" style="pointer-events: none;" class="inline"/></a> <a href="https://ci.appveyor.com/project/npm/ssri"><img src="https://ci.appveyor.com/api/projects/status/github/npm/ssri?svg=true" alt="AppVeyor" class="inline"/></a> <a href="https://coveralls.io/github/npm/ssri?branch=latest"><img src="https://coveralls.io/repos/github/npm/ssri/badge.svg?branch=latest" alt="Coverage Status" style="pointer-events: none;" class="inline"/></a> </div></div>
</div><!--header-->
<div class="contents">
...
<h1><a class="anchor" id="autotoc_md13966"></a>
Install</h1>
...
<li>`parse`</li>
<li>`stringify`</li>
<li>`Integrity#concat`</li>
<li>`Integrity#merge`</li>
<li>`Integrity#toString`</li>
<li>`Integrity#toJSON`</li>
<li>`Integrity#match`</li>
<li>`Integrity#pickAlgorithm`</li>
<li>`Integrity#hexDigest`</li>
</ul>
</li>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13969"></a>
Features</h2>
<ul>
...
Contributing</h2>
<p >The ssri team enthusiastically welcomes contributions and project participation! There's a bunch of things you can do if you want to contribute! The ContributorGuide" has all the information you need for everything from
reporting bugs to contributing entire new features. Please don't hesitate to
jump in if you'd like to, or even ask us questions if something isn't clear.

@subsection autotoc_md13971 API

@subsubsection autotoc_md13972 &lt;a name="parse"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.parse(sri, [opts]) -\&gt; Integrity&lt;/tt&gt;
...
@paragraph autotoc_md13973 Example
...
@subsubsection autotoc_md13974 &lt;a name="stringify"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.stringify(sri, [opts]) -\&gt; String&lt;/tt&gt;
...
@paragraph autotoc_md13975 Example
...
@subsubsection autotoc_md13976 &lt;a name="integrity-concat"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#concat(otherIntegrity, [opts]) -\&gt; Integrity&lt;/tt&gt;
...
@paragraph autotoc_md13977 Example
...
@subsubsection autotoc_md13978 &lt;a name="integrity-merge"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#merge(otherIntegrity, [opts])&lt;/tt&gt;
...
@paragraph autotoc_md13979 Example
...
@subsubsection autotoc_md13980 &lt;a name="integrity-to-string"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#toString([opts]) -\&gt; String&lt;/tt&gt;
...
@paragraph autotoc_md13981 Example
...
@subsubsection autotoc_md13982 &lt;a name="integrity-to-json"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#toJSON() -\&gt; String&lt;/tt&gt;
...
For more info check out &lt;a href="<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify#toJSON%28%29_behavior">https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify#toJSON%28%29_behavior</a>" &gt;toJSON() behavior on mdn&lt;/a&gt;.

@paragraph autotoc_md13983 Example
...
@subsubsection autotoc_md13984 &lt;a name="integrity-match"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#match(sri, [opts]) -\&gt; Hash | false&lt;/tt&gt;
...
@paragraph autotoc_md13985 Example
...
@subsubsection autotoc_md13986 &lt;a name="integrity-pick-algorithm"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#pickAlgorithm([opts]) -\&gt; String&lt;/tt&gt;
...
@paragraph autotoc_md13987 Example
...
@subsubsection autotoc_md13988 &lt;a name="integrity-hex-digest"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; Integrity\#hexDigest() -\&gt; String&lt;/tt&gt;
...
@paragraph autotoc_md13989 Example

@code{javascript} 
ssri.parse('sha1-deadbeef').hexDigest() // '75e69d6de79f'
@endcode

@subsubsection autotoc_md13990 &lt;a name="from-hex"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.fromHex(hexDigest, algorithm, [opts]) -\&gt; Integrity&lt;/tt&gt;
...
@paragraph autotoc_md13991 Example

@code{javascript} 
ssri.fromHex('75e69d6de79f', 'sha1').toString() // 'sha1-deadbeef'
@endcode

@subsubsection autotoc_md13992 &lt;a name="from-data"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.fromData(data, [opts]) -\&gt; Integrity&lt;/tt&gt;
...
@paragraph autotoc_md13993 Example
...
@subsubsection autotoc_md13994 &lt;a name="from-stream"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.fromStream(stream, [opts]) -\&gt; Promise\&lt;Integrity\&gt;&lt;/tt&gt;
...
@paragraph autotoc_md13995 Example
...
@subsubsection autotoc_md13996 &lt;a name="create"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.create([opts]) -\&gt; \&lt;Hash\&gt;&lt;/tt&gt;

Returns a Hash object with &lt;tt&gt;update(\&lt;Buffer or string\&gt;[,enc])&lt;/tt&gt; and &lt;tt&gt;digest()&lt;/tt&gt; methods.


The Hash object provides the same methods as &lt;a href="<a href="https://nodejs.org/dist/latest-v6.x/docs/api/crypto.html#crypto_class_hash">https://nodejs.org/dist/latest-v6.x/docs/api/crypto.html#crypto_class_hash</a>" &gt;crypto class Hash&lt;/a&gt;.
...
@paragraph autotoc_md13997 Example
...
@subsubsection autotoc_md13998 &lt;a name="check-data"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.checkData(data, sri, [opts]) -\&gt; Hash|false&lt;/tt&gt;
...
@paragraph autotoc_md13999 Example
...
@subsubsection autotoc_md14000 &lt;a name="check-stream"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; ssri.checkStream(stream, sri, [opts]) -\&gt; Promise\&lt;Hash\&gt;&lt;/tt&gt;
...
@paragraph autotoc_md14001 Example
...
@subsubsection autotoc_md14002 &lt;a name="integrity-stream"&gt;&lt;/a&gt; &lt;tt&gt;\&gt; integrityStream([opts]) -\&gt; IntegrityStream&lt;/tt&gt;
...
<h4><a class="anchor" id="autotoc_md14003"></a>
Example</h4>
