...
<h2><a class="anchor" id="autotoc_md14612"></a>
Getting Started</h2>
...
<h2><a class="anchor" id="autotoc_md14613"></a>
...
<h2><a class="anchor" id="autotoc_md14614"></a>
Options</h2>
...
<td class="markdownTableBodyCenter">**`test`**   </td><td class="markdownTableBodyCenter"><code>String\|RegExp\|Array&lt;String\|RegExp&gt;</code>   </td><td class="markdownTableBodyCenter"><code>/\.m?js(\?.*)?$/i</code>   </td><td class="markdownTableBodyLeft">Test to match files against.    </td></tr>
<tr class="markdownTableRowEven">
<td class="markdownTableBodyCenter">**`include`**   </td><td class="markdownTableBodyCenter"><code>String\|RegExp\|Array&lt;String\|RegExp&gt;</code>   </td><td class="markdownTableBodyCenter"><code>undefined</code>   </td><td class="markdownTableBodyLeft">Files to include.    </td></tr>
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyCenter">**`exclude`**   </td><td class="markdownTableBodyCenter"><code>String\|RegExp\|Array&lt;String\|RegExp&gt;</code>   </td><td class="markdownTableBodyCenter"><code>undefined</code>   </td><td class="markdownTableBodyLeft">Files to exclude.    </td></tr>
<tr class="markdownTableRowEven">
<td class="markdownTableBodyCenter">**`parallel`**   </td><td class="markdownTableBodyCenter"><code>Boolean\|Number</code>   </td><td class="markdownTableBodyCenter"><code>true</code>   </td><td class="markdownTableBodyLeft">Use multi-process parallel running to improve the build speed.    </td></tr>
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyCenter">**`minify`**   </td><td class="markdownTableBodyCenter"><code>Function</code>   </td><td class="markdownTableBodyCenter"><code>TerserPlugin.terserMinify</code>   </td><td class="markdownTableBodyLeft">Allows you to override default minify function.    </td></tr>
<tr class="markdownTableRowEven">
<td class="markdownTableBodyCenter">**`terserOptions`**   </td><td class="markdownTableBodyCenter"><code>Object</code>   </td><td class="markdownTableBodyCenter"><a href="https://github.com/terser/terser#minify-options"><code>default</code></a>   </td><td class="markdownTableBodyLeft">Terser <a href="https://github.com/terser/terser#minify-options">minify options</a>.    </td></tr>
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyCenter">**`extractComments`**   </td><td class="markdownTableBodyCenter"><code>Boolean\|String\|RegExp\|Function&lt;(node, comment) -&gt; Boolean\|Object&gt;\|Object</code>   </td><td class="markdownTableBodyCenter"><code>true</code>   </td><td class="markdownTableBodyLeft">Whether comments shall be extracted to a separate file.   </td></tr>
</table>
<h3><a class="anchor" id="autotoc_md14615"></a>
&lt;tt&gt;test&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14616"></a>
&lt;tt&gt;include&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14617"></a>
&lt;tt&gt;exclude&lt;/tt&gt;</h3>
<p >Type: <code>String|RegExp|Array&lt;String|RegExp&gt;</code> Default: <code>undefined</code></p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14618"></a>
&lt;tt&gt;parallel&lt;/tt&gt;</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14620"></a>
&lt;tt&gt;Number&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14621"></a>
&lt;tt&gt;minify&lt;/tt&gt;</h3>
<p >Type: <code>Function</code> Default: <code>TerserPlugin.terserMinify</code></p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14622"></a>
&lt;tt&gt;terserOptions&lt;/tt&gt;</h3>
<p >Type: <code>Object</code> Default: <a href="https://github.com/terser/terser#minify-options">default</a></p>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14623"></a>
...
<h4><a class="anchor" id="autotoc_md14624"></a>
&lt;tt&gt;Boolean&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14625"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14626"></a>
&lt;tt&gt;RegExp&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14627"></a>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14628"></a>
&lt;tt&gt;Object&lt;/tt&gt;</h4>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p ><a class="anchor" id="autotoc_md14629"></a> </p><h5><code>condition</code></h5>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p ><a class="anchor" id="autotoc_md14630"></a> </p><h5><code>filename</code></h5>
...
<blockquote class="doxtable">
<p >&zwj;⚠️ We highly recommend using the <code>txt</code> extension. Using <code>js</code>/<code>cjs</code>/<code>mjs</code> extensions may conflict with existing assets which leads to broken code. </p>
</blockquote>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  optimization: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><p ><a class="anchor" id="autotoc_md14631"></a> </p><h5><code>banner</code></h5>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14632"></a>
Examples</h2>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14634"></a>
Remove Comments</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14635"></a>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14636"></a>
&lt;a href="https://github.com/swc-project/swc" &gt;&lt;tt&gt;swc&lt;/tt&gt;&lt;/a&gt;</h3>
...
<blockquote class="doxtable">
<p >&zwj;⚠ the <code>extractComments</code> option is not supported and all comments will be removed by default, it will be fixed in future </p>
</blockquote>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  optimization: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14637"></a>
...
<blockquote class="doxtable">
<p >&zwj;⚠ the <code>extractComments</code> option is not supported and all legal comments (i.e. copyright, licenses and etc) will be preserved </p>
</blockquote>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  optimization: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14638"></a>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md14639"></a>
Typescript</h3>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14640"></a>
Contributing</h2>
