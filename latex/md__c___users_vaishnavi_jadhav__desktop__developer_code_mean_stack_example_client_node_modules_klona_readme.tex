...
A tiny (240B to 501B) and fast utility to \char`\"{}deep clone\char`\"{} Objects, Arrays, Dates, Reg\+Exps, and more!\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7656}{}\doxysubsection{Features}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7656}
...
Unlike a \char`\"{}shallow copy\char`\"{} (eg, {\ttfamily Object.\+assign}), a \char`\"{}deep clone\char`\"{} recursively traverses a source input and copies its {\itshape values} --- instead of {\itshape references} to its values --- into a new instance of that input. The result is a structurally equivalent clone that operates independently of the original source and controls its own values.

\begin{quote}
{\bfseries{Why \char`\"{}klona\char`\"{}?}} It\textquotesingle{}s \char`\"{}clone\char`\"{} in Swedish.~\newline
 {\bfseries{What\textquotesingle{}s with the sheep?}} \href{https://en.wikipedia.org/wiki/Dolly_(sheep)}{\texttt{ Dolly}}. \end{quote}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7657}{}\doxysubsection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7657}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install -\/-\/save klona}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7658}{}\doxysubsection{Modes}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7658}
There are multiple \char`\"{}versions\char`\"{} of {\ttfamily klona} available, which allows you to bring only the functionality you need!\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7659}{}\doxyparagraph{$<$tt$>$klona/json$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7659}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7660}{}\doxyparagraph{$<$tt$>$klona/lite$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7660}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7661}{}\doxyparagraph{$<$tt$>$klona$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7661}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7662}{}\doxyparagraph{$<$tt$>$klona/full$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7662}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7663}{}\doxysubsection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7663}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7664}{}\doxysubsection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7664}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7665}{}\doxysubsubsection{klona(input)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7665}
Returns\+: {\ttfamily typeof input}

Returns a deep copy/clone of the input.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7666}{}\doxysubsection{Benchmarks}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7666}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7667}{}\doxysubsection{Related}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7667}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7668}{}\doxysubsection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_klona_readme_autotoc_md7668}
