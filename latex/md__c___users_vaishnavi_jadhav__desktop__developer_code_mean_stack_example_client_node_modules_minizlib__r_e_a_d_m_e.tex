...
Brotli is supported in versions of node with a Brotli binding.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8825}{}\doxysection{How does this differ from the streams in ‘require(\textquotesingle{}zlib’)\`{}?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8825}
...
See \href{http://npm.im/minipass}{\texttt{ Minipass}} for more on the differences between Node.\+js core streams and Minipass streams, and the convenience methods provided by that class.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8826}{}\doxysection{Classes}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8826}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8827}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8827}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8828}{}\doxysection{REPRODUCIBLE BUILDS}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minizlib__r_e_a_d_m_e_autotoc_md8828}
