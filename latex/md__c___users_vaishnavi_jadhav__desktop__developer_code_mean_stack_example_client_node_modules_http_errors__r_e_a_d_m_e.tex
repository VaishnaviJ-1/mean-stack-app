...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6097}{}\doxysection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6097}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6098}{}\doxysection{Example}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6098}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6099}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6099}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6100}{}\doxysubsection{Error Properties}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6100}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6101}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6101}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6102}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6102}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6103}{}\doxysubsection{create\+Error.\+is\+Http\+Error(val)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6103}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the \char`\"{}duck type\char`\"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6104}{}\doxysubsection{new create\+Error\mbox{[}code $\vert$$\vert$ name\mbox{]}(\mbox{[}msg\mbox{]}))}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6104}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6105}{}\doxysubsubsection{List of all constructors}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6105}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6106}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_http_errors__r_e_a_d_m_e_autotoc_md6106}
