...
Most progress bar modules include a rudimentary version of this, but my needs were more complex.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1993}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1993}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1994}{}\doxysection{Shared Methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1994}
...
This will result in one or more {\ttfamily change} events being emitted.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1995}{}\doxysection{Events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1995}
...
{\ttfamily tracker} is the tracker object that you are listening for events on.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1996}{}\doxysection{Tracker\+Group}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1996}

\begin{DoxyItemize}
\item var tracker = new Tracker\+Group({\bfseries{name}})
\begin{DoxyItemize}
\item {\bfseries{name}} $\ast$(optional)$\ast$ -\/ The name of this tracker group, used in change notifications if the component updating didn\textquotesingle{}t have a name. Defaults to undefined.
\end{DoxyItemize}
\end{DoxyItemize}
...
\item {\bfseries{weight}} $\ast$(optional)$\ast$ -\/ The weight to give the tracker, defaults to 1.
\end{DoxyItemize}
\end{DoxyItemize}
...
Returns a tree showing the completion of this tracker group and all of its children, including recursively entering all of the children.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1997}{}\doxysection{Tracker}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1997}

\begin{DoxyItemize}
\item var tracker = new Tracker({\bfseries{name}}, {\bfseries{todo}})
\begin{DoxyItemize}
\item {\bfseries{name}} $\ast$(optional)$\ast$ The name of this counter to report in change events. Defaults to undefined.
\item {\bfseries{todo}} $\ast$(optional)$\ast$ The amount of work todo (a number). Defaults to 0.
\end{DoxyItemize}
\end{DoxyItemize}
...
Marks this tracker as finished, tracker.\+completed() will now be 1. Triggers a {\ttfamily change} event.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1998}{}\doxysection{Tracker\+Stream}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_are_we_there_yet__r_e_a_d_m_e_autotoc_md1998}

\begin{DoxyItemize}
\item var tracker = new Tracker\+Stream({\bfseries{name}}, {\bfseries{size}}, {\bfseries{options}})
\begin{DoxyItemize}
\item {\bfseries{name}} $\ast$(optional)$\ast$ The name of this counter to report in change events. Defaults to undefined.
\item {\bfseries{size}} $\ast$(optional)$\ast$ The number of bytes being sent through this stream.
\item {\bfseries{options}} $\ast$(optional)$\ast$ A hash of stream options
\end{DoxyItemize}
\end{DoxyItemize}
