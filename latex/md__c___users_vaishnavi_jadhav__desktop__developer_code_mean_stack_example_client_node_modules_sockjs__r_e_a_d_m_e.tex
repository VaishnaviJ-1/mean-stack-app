...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13407}{}\doxysection{What is Sock\+JS?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13407}
Sock\+JS is a Java\+Script library (for browsers) that provides a Web\+Socket-\/like object. Sock\+JS gives you a coherent, cross-\/browser, Javascript API which creates a low latency, full duplex, cross-\/domain communication channel between the browser and the web server, with Web\+Sockets or without. This necessitates the use of a server, which this is one version of, for Node.\+js.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13408}{}\doxysection{Sock\+JS-\/node server}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13408}
...
Subscribe to \href{https://groups.google.com/forum/\#!forum/sockjs}{\texttt{ Sock\+JS mailing list}} for discussions and support.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13409}{}\doxysubsection{Sock\+JS-\/node API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13409}
The API design is based on common Node APIs like the \href{http://nodejs.org/docs/v0.5.8/api/streams.html}{\texttt{ Streams API}} or the \href{http://nodejs.org/docs/v0.5.8/api/http.html\#http.Server}{\texttt{ Http.\+Server API}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13410}{}\doxysubsubsection{Server class}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13410}
...
\end{DoxyDescription}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13411}{}\doxysubsubsection{Server instance}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13411}
...
All http requests that don\textquotesingle{}t go under the path selected by {\ttfamily prefix} will remain unanswered and will be passed to previously registered handlers. You must install your custom http handlers before calling {\ttfamily install\+Handlers}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13412}{}\doxysubsubsection{Connection instance}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13412}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13413}{}\doxysubsubsection{Footnote}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13413}
A fully working echo server does need a bit more boilerplate (to handle requests unanswered by Sock\+JS), see the \href{https://github.com/sockjs/sockjs-node/tree/master/examples/echo}{\texttt{ {\ttfamily echo} example}} for a complete code.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13414}{}\doxysubsubsection{Examples}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13414}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13415}{}\doxysubsection{Connecting to Sock\+JS-\/node without the client}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13415}
...
Note\+: This endpoint will {\itshape not send any heartbeat packets}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13416}{}\doxysubsection{Deployment and load balancing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13416}
There are two issues that need to be considered when planning a non-\/trivial Sock\+JS-\/node deployment\+: Web\+Socket-\/compatible load balancer and sticky sessions (aka session affinity).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13417}{}\doxysubsubsection{Web\+Socket compatible load balancer}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13417}
...
The config also shows how to use HAproxy balancing to split traffic between multiple Node.\+js servers. You can also do balancing using dns names.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13418}{}\doxysubsubsection{Sticky sessions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13418}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13419}{}\doxysubsection{Development and testing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13419}
...
\end{DoxyVerb}
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13420}{}\doxysubsubsection{Sock\+JS-\/protocol Python tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13420}
To run it run something like\+: \begin{DoxyVerb}cd sockjs-protocol
make test_deps
./venv/bin/python sockjs-protocol.py
\end{DoxyVerb}
 For details see \href{https://github.com/sockjs/sockjs-protocol\#readme}{\texttt{ Sock\+JS-\/protocol README}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13421}{}\doxysubsubsection{Sock\+JS-\/client QUnit tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13421}
...
Additionally, if you\textquotesingle{}re doing more serious development consider using {\ttfamily make serve}, which will automatically the server when you modify the source code.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13422}{}\doxysubsection{Various issues and design considerations}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13422}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13423}{}\doxysubsubsection{Authorisation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13423}
...
Basically -\/ cookies are not suited for Sock\+JS model. If you want to authorise a session -\/ provide a unique token on a page, send it as a first thing over Sock\+JS connection and validate it on the server side. In essence, this is how cookies work.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13424}{}\doxysubsubsection{Deploying Sock\+JS on Heroku}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sockjs__r_e_a_d_m_e_autotoc_md13424}
