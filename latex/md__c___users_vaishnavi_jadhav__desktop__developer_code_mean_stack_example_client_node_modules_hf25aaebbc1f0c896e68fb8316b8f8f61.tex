{\ttfamily Cache\+Policy} tells when responses can be reused from a cache, taking into account \href{http://httpwg.org/specs/rfc7234.html}{\texttt{ HTTP RFC 7234}} rules for user agents and shared caches. It also implements \href{https://tools.ietf.org/html/rfc5861}{\texttt{ RFC 5861}}, implementing {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate}. It\textquotesingle{}s aware of many tricky details such as the {\ttfamily Vary} header, proxy revalidation, and authenticated responses.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6053}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6053}
...
The key method is {\ttfamily satisfies\+Without\+Revalidation(new\+Request)}, which checks whether the {\ttfamily new\+Request} is compatible with the original request and whether all caching conditions are met.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6054}{}\doxysubsection{Constructor options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6054}
...
{\ttfamily options.\+cache\+Heuristic} is a fraction of response\textquotesingle{}s age that is used as a fallback cache duration. The default is 0.\+1 (10\%), e.\+g. if a file hasn\textquotesingle{}t been modified for 100 days, it\textquotesingle{}ll be cached for 100$\ast$0.1 = 10 days.
...
If {\ttfamily options.\+ignore\+Cargo\+Cult} is true, common anti-\/cache directives will be completely ignored if the non-\/standard {\ttfamily pre-\/check} and {\ttfamily post-\/check} directives are present. These two useless directives are most commonly found in bad Stack\+Overflow answers and PHP\textquotesingle{}s \char`\"{}session limiter\char`\"{} defaults.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6055}{}\doxysubsection{$<$tt$>$storable()$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6055}
Returns {\ttfamily true} if the response can be stored in a cache. If it\textquotesingle{}s {\ttfamily false} then you MUST NOT store either the request or the response.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6056}{}\doxysubsection{$<$tt$>$satisfies\+Without\+Revalidation(new\+Request)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6056}
...
If it returns {\ttfamily false}, then the response may not be matching at all (e.\+g. it\textquotesingle{}s for a different URL or method), or may require to be refreshed first (see {\ttfamily revalidation\+Headers()}).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6057}{}\doxysubsection{$<$tt$>$response\+Headers()$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6057}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6058}{}\doxysubsection{$<$tt$>$time\+To\+Live()$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6058}
Returns approximate time in {\itshape milliseconds} until the response becomes stale (i.\+e. not fresh).

After that time (when {\ttfamily time\+To\+Live() \texorpdfstring{$<$}{<}= 0}) the response might not be usable without revalidation. However, there are exceptions, e.\+g. a client can explicitly allow stale responses, so always check with {\ttfamily satisfies\+Without\+Revalidation()}. {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate} extend the time to live of the cache, that can still be used if stale.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6059}{}\doxysubsection{$<$tt$>$to\+Object()$<$/tt$>$/$<$tt$>$from\+Object(json)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6059}
Chances are you\textquotesingle{}ll want to store the {\ttfamily Cache\+Policy} object along with the cached response. {\ttfamily obj = policy.\+to\+Object()} gives a plain JSON-\/serializable object. {\ttfamily policy = Cache\+Policy.\+from\+Object(obj)} creates an instance from it.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6060}{}\doxysubsection{Refreshing stale cache (revalidation)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6060}
When a cached response has expired, it can be made fresh again by making a request to the origin server. The server may respond with status 304 (Not Modified) without sending the response body again, saving bandwidth.

The following methods help perform the update efficiently and correctly.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6061}{}\doxysubsubsection{$<$tt$>$revalidation\+Headers(new\+Request)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6061}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6062}{}\doxysubsubsection{$<$tt$>$revalidated\+Policy(revalidation\+Request, revalidation\+Response)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6062}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6063}{}\doxysection{Yo, FRESH}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6063}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6064}{}\doxysubsection{Used by}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6064}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6065}{}\doxysubsection{Implemented}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6065}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6066}{}\doxysubsection{Unimplemented}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6066}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6067}{}\doxysubsubsection{Trusting server $<$tt$>$\+Date$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hf25aaebbc1f0c896e68fb8316b8f8f61_autotoc_md6067}
