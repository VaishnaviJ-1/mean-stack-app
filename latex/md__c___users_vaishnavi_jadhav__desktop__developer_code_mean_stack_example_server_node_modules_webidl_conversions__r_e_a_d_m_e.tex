...
Specific conversions may also accept other options, the details of which can be found below.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19114}{}\doxysection{Conversions implemented}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19114}
...
Derived types, such as nullable types, promise types, sequences, records, etc. are not handled by this library. You may wish to investigate the \href{https://github.com/jsdom/webidl2js}{\texttt{ webidl2js}} project.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19115}{}\doxysubsection{A note on the $<$tt$>$long long$<$/tt$>$ types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19115}
...
On the other hand, {\ttfamily long long} conversion is always accurate, since the input value can never be more precise than the output value.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19116}{}\doxysubsection{A note on $<$tt$>$\+Buffer\+Source$<$/tt$>$ types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19116}
All of the {\ttfamily Buffer\+Source} types will throw when the relevant {\ttfamily Array\+Buffer} has been detached. This technically is not part of the \href{https://heycam.github.io/webidl/\#es-buffer-source-types}{\texttt{ specified conversion algorithm}}, but instead part of the \href{https://heycam.github.io/webidl/\#ref-for-dfn-get-buffer-source-reference\%E2\%91\%A0}{\texttt{ getting a reference/getting a copy}} algorithms. We\textquotesingle{}ve consolidated them here for convenience and ease of implementation, but if there is a need to separate them in the future, please open an issue so we can investigate.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19117}{}\doxysection{Background}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_webidl_conversions__r_e_a_d_m_e_autotoc_md19117}
