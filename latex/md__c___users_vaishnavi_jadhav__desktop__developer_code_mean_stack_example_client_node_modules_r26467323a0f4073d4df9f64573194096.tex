...
Jump to the $\ast$$\ast$\char`\"{}how to\char`\"{}$\ast$$\ast$ section -\/
\begin{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11863}{}\doxysection{What is the \char`\"{}join\char`\"{} function?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11863}
The \char`\"{}join\char`\"{} function determines how CSS URIs are combined with one of the possible base paths the algorithm has identified.

⚠️ {\bfseries{IMPORTANT}} -\/ First read how the \href{./how-it-works.md\#algorithm}{\texttt{ algorithm}} works.

The \char`\"{}join\char`\"{} function is a higher-\/order function created using the {\ttfamily options} and {\ttfamily loader} reference. That gives a function that accepts a single {\ttfamily item} and synchronously returns an absolute asset path to substitute back into the original CSS.
...
The job of the \char`\"{}join\char`\"{} function is to consider possible locations for the asset based on the {\ttfamily bases} and determine which is most appropriate. This implies some order of precedence in these locations and some file-\/system operation to determine if the asset there.

The default implementation is suitable for most users but can be customised per the {\ttfamily join} option.

A custom {\ttfamily join} function from scratch is possible but we\textquotesingle{}ve provided some building blocks to make the task easier.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11864}{}\doxysection{Building blocks}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11864}
There are a number of utilities (defined in \href{../lib/join-function/index.js}{\texttt{ {\ttfamily lib/join-\/function/index.\+js}}}) to help construct a custom \char`\"{}join\char`\"{} function . These are conveniently re-\/exported as properties of the loader.
...
Don\textquotesingle{}t worry, you don\textquotesingle{}t need to use {\ttfamily function$\ast$} semantics for the {\ttfamily generator} unless you want to.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11865}{}\doxysection{Simple customisation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11865}
...
See the reference or jump directly to the examples.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11866}{}\doxysubsection{Reference}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11866}
...
If you\textquotesingle{}re interested only in the {\ttfamily base} path and don\textquotesingle{}t intend to vary the {\ttfamily uri} then the {\ttfamily as\+Generator} utility saves you having to create repetative tuples (and from using {\ttfamily function$\ast$} semantics).
...
\item {\bfseries{When should I use {\ttfamily function$\ast$}?}}

If you need lazy generation of values then you may return {\ttfamily Iterator} or use {\ttfamily function$\ast$} semantics. Refer to \href{https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Iterators_and_Generators}{\texttt{ this guide on Iterators}}.
...
The {\ttfamily generator} is focussed on identifying locations to search. It is a more scalable concept where you wish to search many places. The traditional use case for the custom \char`\"{}join\char`\"{} function is a file-\/system search so the {\ttfamily generator} was designed to make this possible.
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11867}{}\doxysubsection{How to\+: change precedence of source locations}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11867}
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11868}{}\doxysubsection{How to\+: fallback to a theme or other global directory}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11868}
 Additional locations can be added by decorating the default generator. This is popular for adding some sort of \char`\"{}theme\char`\"{} directory containing assets.
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11869}{}\doxysubsection{How to\+: fallback to some other asset file}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11869}
...
{\bfseries{Using {\ttfamily function$\ast$}}}
...
\item The {\ttfamily as\+Generator} utility allows us to return {\ttfamily Array\texorpdfstring{$<$}{<}\mbox{[}string, string\mbox{]}\texorpdfstring{$>$}{>}} but is {\bfseries{not}} needed when we use {\ttfamily function$\ast$} semantics.
\end{DoxyItemize}
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11870}{}\doxysubsection{How to\+: perform a file-\/system search for an asset}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11870}
...
\item By using {\ttfamily function$\ast$} the generator is lazy. We only walk the file-\/system directory tree as necessary.
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11871}{}\doxysection{Full customisation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11871}
...
It provides additional logging when using {\ttfamily debug} option so is a better choice then writing a \char`\"{}join\char`\"{} function from scratch.
...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11872}{}\doxysubsection{Reference}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r26467323a0f4073d4df9f64573194096_autotoc_md11872}
