...
This makes Needle an ideal alternative for performing quick HTTP requests in Node, either for API interaction, downloading or uploading streams of data, and so on. If you need OAuth, AWS support or anything fancier, you should check out mikeal\textquotesingle{}s request module.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8958}{}\doxysection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8958}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install needle}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8959}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8959}
...
When no callback is passed, however, the buffering logic will be skipped but the response stream will still go through Needle\textquotesingle{}s processing pipeline, so you get all the benefits of post-\/processing while keeping the streamishness we all love from Node.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8960}{}\doxysection{Response pipeline}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8960}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8961}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8961}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8962}{}\doxysubsection{needle(method, url\mbox{[}, data\mbox{]}\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]}) $<$tt$>$($>$ 2.\+0.\+x)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8962}
...
Except from the above, all of Needle\textquotesingle{}s request methods return a Readable stream, and both {\ttfamily options} and {\ttfamily callback} are optional. If passed, the callback will return three arguments\+: {\ttfamily error}, {\ttfamily response} and {\ttfamily body}, which is basically an alias for {\ttfamily response.\+body}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8963}{}\doxysubsection{needle.\+head(url\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8963}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8964}{}\doxysubsection{needle.\+get(url\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8964}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8965}{}\doxysubsection{needle.\+post(url, data\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8965}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8966}{}\doxysubsection{needle.\+put(url, data\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8966}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8967}{}\doxysubsection{needle.\+patch(url, data\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8967}
Same behaviour as PUT.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8968}{}\doxysubsection{needle.\+delete(url, data\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8968}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8969}{}\doxysubsection{needle.\+request(method, url, data\mbox{[}, options\mbox{]}\mbox{[}, callback\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8969}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8970}{}\doxysection{Events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8970}
The \href{https://nodejs.org/api/stream.html\#stream_class_stream_readable}{\texttt{ Readable stream}} object returned by the above request methods emits the following events, in addition to the regular ones (e.\+g. {\ttfamily end}, {\ttfamily close}, {\ttfamily data}, {\ttfamily pipe}, {\ttfamily readable}).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8971}{}\doxysubsection{Event\+: ‘\textquotesingle{}response’\`{}}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8971}

\begin{DoxyItemize}
\item {\ttfamily response \texorpdfstring{$<$}{<}http.\+Incoming\+Message\texorpdfstring{$>$}{>}}
\end{DoxyItemize}

Emitted when the underlying \href{https://nodejs.org/api/http.html\#http_class_http_clientrequest}{\texttt{ http.\+Client\+Request}} emits a response event. This is after the connection is established and the header received, but before any of it is processed (e.\+g. authorization required or redirect to be followed). No data has been consumed at this point.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8972}{}\doxysubsection{Event\+: ‘\textquotesingle{}redirect’\`{}}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8972}

\begin{DoxyItemize}
\item {\ttfamily location \texorpdfstring{$<$}{<}String\texorpdfstring{$>$}{>}}
\end{DoxyItemize}

Indicates that the a redirect is being followed. This means that the response code was a redirect ({\ttfamily 301}, {\ttfamily 302}, {\ttfamily 303}, {\ttfamily 307}) and the given redirect options allowed following the URL received in the {\ttfamily Location} header.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8973}{}\doxysubsection{Event\+: ‘\textquotesingle{}header’\`{}}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8973}
...
Triggered after the header has been processed, and just before the data is to be consumed. This implies that no redirect was followed and/or authentication header was received. In other words, we got a \char`\"{}valid\char`\"{} response.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8974}{}\doxysubsection{Event\+: ‘\textquotesingle{}done’‘ (previously \textquotesingle{}end’)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8974}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8975}{}\doxysubsection{Event\+: ‘\textquotesingle{}err’\`{}}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8975}

\begin{DoxyItemize}
\item {\ttfamily exception \texorpdfstring{$<$}{<}Error\texorpdfstring{$>$}{>}}
\end{DoxyItemize}

Emitted when an error ocurrs. This should only happen once in the lifecycle of a Needle request.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8976}{}\doxysubsection{Event\+: ‘\textquotesingle{}timeout’\`{}}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8976}

\begin{DoxyItemize}
\item {\ttfamily type \texorpdfstring{$<$}{<}String\texorpdfstring{$>$}{>}}
\end{DoxyItemize}

Emitted when an timeout error occurs. Type can be either \textquotesingle{}open\textquotesingle{}, \textquotesingle{}response\textquotesingle{}, or \textquotesingle{}read\textquotesingle{}. This will called right before aborting the request, which will also trigger an {\ttfamily err} event, a described above, with an {\ttfamily ECONNRESET} (Socket hang up) exception.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8977}{}\doxysection{Request options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8977}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8979}{}\doxysection{HTTP Header options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8979}
...
\item {\ttfamily accept} \+: Sets \textquotesingle{}Accept\textquotesingle{} HTTP header. Defaults to {\ttfamily $\ast$/$\ast$}.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8980}{}\doxysection{Node.\+js TLS Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8980}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8981}{}\doxysection{Redirect options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8981}
These options only apply if the {\ttfamily follow\+\_\+max} (or {\ttfamily follow}) option is higher than 0.


\begin{DoxyItemize}
\item {\ttfamily follow\+\_\+set\+\_\+cookies} \+: Sends the cookies received in the {\ttfamily set-\/cookie} header as part of the following request. {\ttfamily false} by default.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8982}{}\doxysection{Overriding Defaults}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8982}
...
This will override Needle\textquotesingle{}s default user agent and 10-\/second timeout, and disable response parsing, so you don\textquotesingle{}t need to pass those options in every other request.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8983}{}\doxysection{More advanced Proxy support}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8983}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8984}{}\doxysection{Regarding the \textquotesingle{}\+Connection\textquotesingle{} header}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8984}
...
So if you\textquotesingle{}re stuck on 0.\+10 or even lower and want full speed, you can simply set the Connection header to \textquotesingle{}Keep-\/\+Alive\textquotesingle{} by using `\{ connection\+: \textquotesingle{}Keep-\/\+Alive' \}{\ttfamily . Please note, though, that an event loop handler will prevent the runtime from exiting so you\textquotesingle{}ll need to manually call}process.\+exit()\`{} or the universe will collapse.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8985}{}\doxysection{Examples Galore}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8985}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8986}{}\doxysubsection{HTTPS GET with Basic Auth}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8986}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8987}{}\doxysubsection{Digest Auth}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8987}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8988}{}\doxysubsection{Custom Accept header, deflate}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8988}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8989}{}\doxysubsection{GET XML object}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8989}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8990}{}\doxysubsection{GET binary, output to file}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8990}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8991}{}\doxysubsection{GET through proxy}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8991}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8992}{}\doxysubsection{GET a very large document in a stream (from 0.\+7+)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8992}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8993}{}\doxysubsection{GET JSON object in a stream (from 0.\+7+)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8993}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8994}{}\doxysubsection{GET JSONStream flexible parser with search query (from 0.\+7+)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8994}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8995}{}\doxysubsection{File upload using multipart, passing file path}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8995}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8996}{}\doxysubsection{Stream upload, PUT or POST}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8996}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8997}{}\doxysubsection{Multipart POST, passing data buffer}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8997}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8998}{}\doxysubsection{Multipart with custom Content-\/\+Type}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8998}
...
For even more examples, check out the examples directory in the repo.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8999}{}\doxysubsection{Testing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md8999}
...
\end{DoxyVerb}
 Then you should be able to run {\ttfamily npm test} once you have the dependencies in place.

\begin{quote}
Note\+: Tests currently only work on linux-\/based environments that have {\ttfamily /proc/self/fd}. They {\itshape do not} work on Mac\+OS environments. You can use Docker to run tests by creating a container and mounting the needle project directory on {\ttfamily /app} {\ttfamily docker create -\/-\/name Needle -\/v /app -\/w /app -\/v /app/node\+\_\+modules -\/i node\+:argon} \end{quote}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md9000}{}\doxysection{Credits}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md9000}
Written by Tomás Pollak, with the help of contributors.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md9001}{}\doxysection{Copyright}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_needle__r_e_a_d_m_e_autotoc_md9001}
