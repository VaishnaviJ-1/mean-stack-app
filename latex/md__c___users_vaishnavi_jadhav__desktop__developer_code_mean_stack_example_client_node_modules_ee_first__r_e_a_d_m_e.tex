...
Get the first event in a set of event emitters and event pairs, then clean up after itself.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4527}{}\doxysection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4527}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install ee-\/first}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4528}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4528}

\begin{DoxyCode}{0}
\DoxyCodeLine{var first = require('ee-\/first')}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4529}{}\doxysubsection{first(arr, listener)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4529}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4530}{}\doxysubsubsection{.\+cancel()}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ee_first__r_e_a_d_m_e_autotoc_md4530}
