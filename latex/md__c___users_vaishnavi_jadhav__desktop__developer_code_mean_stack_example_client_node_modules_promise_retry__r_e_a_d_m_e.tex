...
There\textquotesingle{}s already some modules that are able to retry functions that return promises but they were rather difficult to use or do not offer an easy way to do conditional retries.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11410}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11410}
{\ttfamily \$ npm install promise-\/retry}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11411}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11411}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11412}{}\doxysubsection{promise\+Retry(fn, \mbox{[}options\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11412}
...
If you prefer, you can pass the options first using the alternative function signature {\ttfamily promise\+Retry(\mbox{[}options\mbox{]}, fn)}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11413}{}\doxysection{Example}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11413}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11414}{}\doxysection{Tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11414}
{\ttfamily \$ npm test}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11415}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_promise_retry__r_e_a_d_m_e_autotoc_md11415}
