...
Powered by the popular Nodejitsu \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ {\ttfamily http-\/proxy}}}. \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ }}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6117}{}\doxysection{⚠️ Note}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6117}
This page is showing documentation for version v1.\+x.\+x (\href{https://github.com/chimurai/http-proxy-middleware/releases}{\texttt{ release notes}})

If you\textquotesingle{}re looking for v0.\+x documentation. Go to\+: \href{https://github.com/chimurai/http-proxy-middleware/tree/v0.21.0\#readme}{\texttt{ https\+://github.\+com/chimurai/http-\/proxy-\/middleware/tree/v0.\+21.\+0\#readme}}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6118}{}\doxysection{TL;\+DR}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6118}
...
{\itshape All} {\ttfamily http-\/proxy} \href{https://github.com/nodejitsu/node-http-proxy\#options}{\texttt{ options}} can be used, along with some extra {\ttfamily http-\/proxy-\/middleware} \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_forge__r_e_a_d_m_e_options}{options}}.

\+:bulb\+: {\bfseries{Tip\+:}} Set the option {\ttfamily change\+Origin} to {\ttfamily true} for \href{http://en.wikipedia.org/wiki/Virtual_hosting\#Name-based}{\texttt{ name-\/based virtual hosted sites}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6119}{}\doxysection{Table of Contents}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6119}
...
\item Shorthand
\begin{DoxyItemize}
\item app.use\textbackslash{}(path, proxy\textbackslash{})
\end{DoxyItemize}
\item Web\+Socket
\begin{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6120}{}\doxysection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6120}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install -\/-\/save-\/dev http-\/proxy-\/middleware}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6121}{}\doxysection{Core concept}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6121}
Proxy middleware configuration.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6122}{}\doxysubsubsection{create\+Proxy\+Middleware(\mbox{[}context,\mbox{]} config)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6122}
...
(full list of \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_forge__r_e_a_d_m_e_options}{\`{}http-\/proxy-\/middleware\`{} configuration options}})\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6123}{}\doxysubsubsection{create\+Proxy\+Middleware(uri \mbox{[}, config\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6123}
...
More about the shorthand configuration.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6124}{}\doxysection{Example}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6124}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6125}{}\doxysection{Context matching}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6125}
...
\begin{DoxyItemize}
\item `create\+Proxy\+Middleware('$\ast$$\ast$\textquotesingle{}, \{...\}){\ttfamily matches any path, all requests will be proxied. -\/}create\+Proxy\+Middleware(\textquotesingle{}$\ast$$\ast$/$\ast$.html\textquotesingle{}, \{...\}){\ttfamily matches any path which ends with}.html{\ttfamily  -\/}create\+Proxy\+Middleware(\textquotesingle{}/$\ast$.html\textquotesingle{}, \{...\}){\ttfamily matches paths directly under path-\/absolute -\/}create\+Proxy\+Middleware(\textquotesingle{}/api/$\ast$$\ast$/$\ast$.html\textquotesingle{}, \{...\}){\ttfamily matches requests ending with}.html{\ttfamily in the path of}/api{\ttfamily  -\/}create\+Proxy\+Middleware(\mbox{[}\textquotesingle{}/api/$\ast$$\ast$\textquotesingle{}, \textquotesingle{}/ajax/$\ast$$\ast$\textquotesingle{}\mbox{]}, \{...\}){\ttfamily combine multiple patterns -\/}create\+Proxy\+Middleware(\mbox{[}\textquotesingle{}/api/$\ast$$\ast$\textquotesingle{}, \textquotesingle{}!$\ast$$\ast$/bad.json\textquotesingle{}\mbox{]}, \{...\})\`{} exclusion
\end{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6126}{}\doxysection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6126}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6127}{}\doxysubsection{http-\/proxy-\/middleware options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6127}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6128}{}\doxysubsection{http-\/proxy events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6128}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6129}{}\doxysubsection{http-\/proxy options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6129}
...
\begin{DoxyItemize}
\item {\ttfamily false} (default)\+: disable cookie rewriting
\item String\+: new path, for example {\ttfamily cookie\+Path\+Rewrite\+: \char`\"{}/new\+Path/\char`\"{}}. To remove the path, use {\ttfamily cookie\+Path\+Rewrite\+: \char`\"{}\char`\"{}}. To set path to root use {\ttfamily cookie\+Path\+Rewrite\+: \char`\"{}/\char`\"{}}.
\item Object\+: mapping of paths to new paths, use {\ttfamily \char`\"{}$\ast$\char`\"{}} to match all paths. For example, to keep one path unchanged, rewrite one path and remove other paths\+: 
\begin{DoxyCode}{0}
...
\end{DoxyItemize}
\item {\bfseries{option.\+headers}}\+: object, adds \href{https://en.wikipedia.org/wiki/List_of_HTTP_header_fields\#Request_fields}{\texttt{ request headers}}. (Example\+: `\{host\+:\textquotesingle{}www.\+example.\+org'\}\`{})
\item {\bfseries{option.\+proxy\+Timeout}}\+: timeout (in millis) when proxy receives no response from target
\item {\bfseries{option.\+timeout}}\+: timeout (in millis) for incoming requests
\item {\bfseries{option.\+follow\+Redirects}}\+: true/false, Default\+: false -\/ specify whether you want to follow redirects
\item {\bfseries{option.\+self\+Handle\+Response}} true/false, if set to true, none of the web\+Outgoing passes are called and it\textquotesingle{}s your responsibility to appropriately return the response by listening and acting on the {\ttfamily proxy\+Res} event
\item {\bfseries{option.\+buffer}}\+: stream of data to send as the request body. Maybe you have some middleware that consumes the request stream before proxying it on e.\+g. If you read the body of a request into a field called \textquotesingle{}req.\+rawbody\textquotesingle{} you could restream this field in the buffer option\+:
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6130}{}\doxysection{Shorthand}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6130}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6131}{}\doxysubsection{app.\+use(path, proxy)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6131}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6132}{}\doxysection{Web\+Socket}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6132}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6133}{}\doxysubsection{External Web\+Socket upgrade}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6133}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6134}{}\doxysection{Intercept and manipulate requests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6134}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6135}{}\doxysection{Intercept and manipulate responses}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6135}
...
Check out \href{https://github.com/chimurai/http-proxy-middleware/blob/master/recipes/response-interceptor.md\#readme}{\texttt{ interception recipes}} for more examples.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6136}{}\doxysection{Working examples}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6136}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6137}{}\doxysection{Recipes}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6137}
View the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes}{\texttt{ recipes}} for common use cases.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6138}{}\doxysection{Compatible servers}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6138}
...
Sample implementations can be found in the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes/servers.md}{\texttt{ server recipes}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6139}{}\doxysection{Tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6139}
Run the test suite\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6140}{}\doxysection{Changelog}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6140}

\begin{DoxyItemize}
\item \href{https://github.com/chimurai/http-proxy-middleware/blob/master/CHANGELOG.md}{\texttt{ View changelog}}
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6141}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hd93043c16eeceed82d0470eebb3fa34e_autotoc_md6141}
The MIT License (MIT)
