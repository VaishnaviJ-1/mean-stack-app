...
Note\+: this is primarily useful for the {\ttfamily Collect.\+Pass\+Through} class, since Minipass streams already have a {\ttfamily .collect()} method which returns a promise that resolves to the array of chunks, and a {\ttfamily .concat()} method that returns the data concatenated into a single Buffer or String.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_collect__r_e_a_d_m_e_autotoc_md8777}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_collect__r_e_a_d_m_e_autotoc_md8777}
