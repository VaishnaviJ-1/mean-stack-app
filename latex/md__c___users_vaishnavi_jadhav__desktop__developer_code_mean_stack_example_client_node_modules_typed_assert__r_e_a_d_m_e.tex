...
See the \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__a_p_i}{documentation}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15138}{}\doxysubsection{Consider using $<$a href=\char`\"{}https\+://github.\+com/colinhacks/zod\char`\"{} $>$$<$tt$>$zod$<$/tt$>$$<$/a$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15138}
While this library does a fine job for most simple use cases, please consider using \href{https://github.com/colinhacks/zod}{\texttt{ {\ttfamily zod}}} if you need more complex assertions.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15139}{}\doxysubsection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15139}

\begin{DoxyCode}{0}
\DoxyCodeLine{or}
\DoxyCodeLine{}
\DoxyCodeLine{```yarn add typed-\/assert}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15140}{}\doxysubsection{Why is it useful?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15140}
{\ttfamily typed-\/assert} promotes using {\ttfamily unknown} instead of {\ttfamily any} for \char`\"{}untrusted\char`\"{} values, e.\+g. user input, while still benefiting from incremental typing.
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15141}{}\doxysubsection{How is it different from chai, jest.\+expect, etc?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15141}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15142}{}\doxysubsection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15142}
{\ttfamily typed-\/assert} comes with a set of common assertions, as well as assertion combinators and utilities.

See \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__a_p_i}{the documentation}} for a full reference.
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15143}{}\doxysubsection{Configuration}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15143}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15144}{}\doxysubsection{Caveats}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_typed_assert__r_e_a_d_m_e_autotoc_md15144}
