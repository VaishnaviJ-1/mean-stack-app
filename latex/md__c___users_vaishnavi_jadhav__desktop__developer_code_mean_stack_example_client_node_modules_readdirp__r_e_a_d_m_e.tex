...
For more examples, check out {\ttfamily examples} directory.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11695}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11695}
...
First argument is awalys {\ttfamily root}, path in which to start reading and recursing into subdirectories.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11696}{}\doxysubsection{options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11696}
...
\item {\bfseries{Glob string}}\+: a string (e.\+g., {\ttfamily $\ast$.js}) which is matched using \href{https://github.com/micromatch/picomatch}{\texttt{ picomatch}}, so go there for more information. Globstars ({\ttfamily $\ast$$\ast$}) are not supported since specifying a recursive pattern for an already recursive function doesn\textquotesingle{}t make sense. Negated globs (as explained in the minimatch documentation) are allowed, e.\+g., {\ttfamily !$\ast$.txt} matches everything but text files.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11697}{}\doxysubsection{$<$tt$>$\+Entry\+Info$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11697}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11698}{}\doxysection{Changelog}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11698}
...
\item 3.\+1 (Jul 7, 2019) brings {\ttfamily bigint} support to {\ttfamily stat} output on Windows. This is backwards-\/incompatible for some cases. Be careful. It you use it incorrectly, you\textquotesingle{}ll see \char`\"{}\+Type\+Error\+: Cannot mix Big\+Int and other types, use explicit conversions\char`\"{}.
...
{\ttfamily {\ttfamily }}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11699}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_readdirp__r_e_a_d_m_e_autotoc_md11699}
