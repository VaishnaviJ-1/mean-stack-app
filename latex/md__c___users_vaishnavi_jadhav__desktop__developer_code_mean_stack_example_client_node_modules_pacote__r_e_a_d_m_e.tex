Fetches package manifests and tarballs from the npm registry.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md9998}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md9998}
...
{\ttfamily prepare} scripts will be run when generating tarballs from {\ttfamily git} and {\ttfamily directory} locations, to simulate what {\itshape would} be published to the registry, so that you get a working package instead of just raw source code that might need to be transpiled.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md9999}{}\doxysection{CLI}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md9999}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10000}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10000}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10001}{}\doxysubsection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10001}
...
\item {\ttfamily umask} Permission mode mask for extracted files and directories. Defaults to {\ttfamily 0o22}. See \char`\"{}\+Extracted File Modes\char`\"{} below.
\item {\ttfamily fmode} Minimum permission mode for extracted files. Defaults to {\ttfamily 0o666}. See \char`\"{}\+Extracted File Modes\char`\"{} below.
\item {\ttfamily dmode} Minimum permission mode for extracted directories. Defaults to {\ttfamily 0o777}. See \char`\"{}\+Extracted File Modes\char`\"{} below.
\item {\ttfamily log} A logger object with methods for various log levels. Typically, this will be \href{http://npm.im/npmlog}{\texttt{ {\ttfamily npmlog}}} in the npm CLI use case, but if not specified, the default is a logger that emits `\textquotesingle{}log'{\ttfamily events on the}process{\ttfamily object. $\ast$}prefer\+Online{\ttfamily Prefer to revalidate cache entries, even when it would not be strictly necessary. Default}false{\ttfamily . $\ast$}before{\ttfamily When picking a manifest from a packument, only consider packages published before the specified date. Default}null{\ttfamily . $\ast$}default\+Tag{\ttfamily The default}dist-\/tag{\ttfamily to use when choosing a manifest from a packument. Defaults to}latest{\ttfamily . $\ast$}registry{\ttfamily The npm registry to use by default. Defaults to }\href{https://registry.npmjs.org/}{\texttt{ https\+://registry.\+npmjs.\+org/}}{\ttfamily . $\ast$}full\+Metadata\`{} Fetch the full metadata from the registry for packuments, including information not strictly required for installation (author, description, etc.) Defaults to {\ttfamily true} when {\ttfamily before} is set, since the version publish time is part of the extended packument metadata.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10002}{}\doxysubsection{Advanced API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10002}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10003}{}\doxysection{Extracted File Modes}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10003}
...
In almost every case, the defaults are appropriate. To respect exactly what is in the package tarball (even if this makes an unusable system), set both {\ttfamily dmode} and {\ttfamily fmode} options to {\ttfamily 0}. Otherwise, the {\ttfamily umask} config should be used in most cases where file mode modifications are required, and this functions more or less the same as the {\ttfamily umask} value in most Unix systems.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10004}{}\doxysection{Extracted File Ownership}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10004}
...
This prevents {\ttfamily root}-\/owned files showing up in a project\textquotesingle{}s {\ttfamily node\+\_\+modules} folder when a user runs {\ttfamily sudo npm install}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10005}{}\doxysection{Manifests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10005}
...
\item {\ttfamily npm-\/signature} A signature of the package by the \href{https://keybase.io/npmregistry}{\texttt{ {\ttfamily npmregistry}}} Keybase account. (Obviously only present for packages published to {\ttfamily \href{https://registry.npmjs.org}{\texttt{ https\+://registry.\+npmjs.\+org}}}.)
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10006}{}\doxysection{Packuments}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_pacote__r_e_a_d_m_e_autotoc_md10006}
