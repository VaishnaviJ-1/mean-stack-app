...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1061}{}\doxysubsection{Features Supported}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1061}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1062}{}\doxysubsection{Installation \& Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1062}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1063}{}\doxysubsection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1063}
...
The {\ttfamily loose} setting turns off a rarely-\/needed function name workaround for older versions of Edge. If you\textquotesingle{}re not relying on {\ttfamily Function.\+prototype.\+name}, it\textquotesingle{}s worth enabling loose mode.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1064}{}\doxysubsection{How does it work?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1064}
Babel’s {\ttfamily preset-\/env} is great, since it lets you define which Babel features are needed based on a browser support target. In order to make that plumbing work automatically, the preset has configuration that groups all of the new Java\+Script syntax features into collections of related syntax transforms. These groups are fairly large, for example \char`\"{}function arguments\char`\"{} includes destructured, default and rest parameters. The groupings come from the fact that Babel’s transforms often rely on other transforms, so they can’t always be applied in isolation.
...
The result is improved bundle size and performance, while supporting the same browsers.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1065}{}\doxysubsection{Important\+: Minification}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules__de8c03802d0ea7536d6b0b66b2497593_autotoc_md1065}
