...
Errors are proxied along the chain and emitted on the Pipeline stream.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8793}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8793}
...
Pipeline is a \href{http://npm.im/minipass}{\texttt{ minipass}} stream, so it\textquotesingle{}s as synchronous as the streams it wraps. It will buffer data until there is a reader, but no longer, so make sure to attach your listeners before you pipe it somewhere else.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8794}{}\doxysection{$<$tt$>$new Pipeline(opts = \{\}, ...\+streams)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8794}
Create a new Pipeline with the specified Minipass options and any streams provided.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8795}{}\doxysection{$<$tt$>$pipeline.\+push(stream, ...)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8795}
Attach one or more streams to the pipeline at the end (read) side of the pipe chain.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8796}{}\doxysection{$<$tt$>$pipeline.\+unshift(stream, ...)$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass_pipeline__r_e_a_d_m_e_autotoc_md8796}
