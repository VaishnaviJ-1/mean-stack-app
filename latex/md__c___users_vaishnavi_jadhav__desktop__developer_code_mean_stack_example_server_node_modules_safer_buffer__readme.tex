Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18482}{}\doxysection{How to use?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18482}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18483}{}\doxysection{Do I need it?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18483}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18484}{}\doxysection{Why not $<$a href=\char`\"{}https\+://npmjs.\+com/safe-\/buffer\char`\"{} $>$safe-\/buffer$<$/a$>$?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18484}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18485}{}\doxysection{But isn\textquotesingle{}t throwing bad?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18485}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18486}{}\doxysubsection{Would it affect third-\/party modules?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18486}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18487}{}\doxysubsection{But I don\textquotesingle{}t want throwing…}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18487}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18488}{}\doxysection{«\+Without footguns»?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__readme_autotoc_md18488}
