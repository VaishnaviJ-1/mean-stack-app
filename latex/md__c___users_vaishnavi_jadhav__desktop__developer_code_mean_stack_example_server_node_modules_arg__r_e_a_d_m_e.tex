{\ttfamily arg} is yet another command line option parser.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16748}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16748}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16749}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16749}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16750}{}\doxysubsection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16750}
If a second parameter is specified and is an object, it specifies parsing options to modify the behavior of {\ttfamily arg()}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16751}{}\doxysubsubsection{$<$tt$>$argv$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16751}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16752}{}\doxysubsubsection{$<$tt$>$permissive$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16752}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16753}{}\doxysubsubsection{$<$tt$>$stop\+At\+Positional$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16753}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16754}{}\doxysubsection{Errors}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16754}
Some errors that {\ttfamily arg} throws provide a {\ttfamily .code} property in order to aid in recovering from user error, or to differentiate between user error and developer error (bug).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16755}{}\doxyparagraph{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16755}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16756}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__r_e_a_d_m_e_autotoc_md16756}
Copyright \copyright{} 2017-\/2019 by ZEIT, Inc. Released under the \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_arg__l_i_c_e_n_s_e}{MIT License}}. 