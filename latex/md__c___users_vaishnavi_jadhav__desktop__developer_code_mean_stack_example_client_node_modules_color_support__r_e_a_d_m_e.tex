...
\end{DoxyEnumerate}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3108}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3108}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3109}{}\doxysection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3109}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3110}{}\doxysection{Return Value}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3110}
If no color support is available, then {\ttfamily false} is returned by default, unless the {\ttfamily always\+Return} flag is set to {\ttfamily true}. This is so that the simple question of \char`\"{}can I use colors or not\char`\"{} can treat any truthy return as \char`\"{}yes\char`\"{}.
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3111}{}\doxysection{CLI}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3111}
You can run the {\ttfamily color-\/support} bin from the command line which will just dump the values as this module calculates them in whatever env it\textquotesingle{}s run. It takes no command line arguments.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3112}{}\doxysection{Credits}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_color_support__r_e_a_d_m_e_autotoc_md3112}
