...
Reuse your objects and functions for maximum speed. This technique will make any function run $\sim$10\% faster. You call your functions a lot, and it adds up quickly in hot code paths.
...
This library was extracted from \href{http://npm.im/fastparallel}{\texttt{ fastparallel}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12029}{}\doxysection{Example}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12029}
...
Also note how in the above examples, the code, that consumes an istance of {\ttfamily My\+Object}, reset the state to initial condition, just before storing it in the cache. That\textquotesingle{}s needed so that every subsequent request for an instance from the cache, could get a clean instance.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12030}{}\doxysection{Why}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12030}
It is faster because V8 doesn\textquotesingle{}t have to collect all the functions you create. On a short-\/lived benchmark, it is as fast as creating the nested function, but on a longer time frame it creates less pressure on the garbage collector.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12031}{}\doxysection{Other examples}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12031}
If you want to see some complex example, checkout \href{https://github.com/fastify/middie}{\texttt{ middie}} and \href{https://github.com/mcollina/steed}{\texttt{ steed}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12032}{}\doxysection{Acknowledgements}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12032}
Thanks to \href{https://github.com/trevnorris}{\texttt{ Trevor Norris}} for getting me down the rabbit hole of performance, and thanks to \href{http://github.com/mafintosh}{\texttt{ Mathias Buss}} for suggesting me to share this trick.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12033}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_reusify__r_e_a_d_m_e_autotoc_md12033}
MIT 