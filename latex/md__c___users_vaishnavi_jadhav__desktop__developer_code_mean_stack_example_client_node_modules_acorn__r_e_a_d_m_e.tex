A tiny, fast Java\+Script parser written in Java\+Script.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1745}{}\doxysection{Community}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1745}
...
You are welcome to \href{https://github.com/acornjs/acorn/issues}{\texttt{ report bugs}} or create pull requests on \href{https://github.com/acornjs/acorn}{\texttt{ github}}. For questions and discussion, please use the \href{https://discuss.ternjs.net}{\texttt{ Tern discussion forum}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1746}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1746}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1747}{}\doxysection{Interface}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1747}
...
\begin{DoxyItemize}
\item {\bfseries{ecma\+Version}}\+: Indicates the ECMAScript version to parse. Must be either 3, 5, 6 (or 2015), 7 (2016), 8 (2017), 9 (2018), 10 (2019), 11 (2020), 12 (2021), 13 (2022, partial support) or {\ttfamily \char`\"{}latest\char`\"{}} (the latest the library supports). This influences support for strict mode, the set of reserved words, and support for new syntax features.
...
{\bfseries{NOTE}}\+: If set to {\ttfamily \char`\"{}module\char`\"{}}, then static {\ttfamily import} / {\ttfamily export} syntax will be valid, even if {\ttfamily ecma\+Version} is less than 6.
...
\item {\bfseries{allow\+Import\+Export\+Everywhere}}\+: By default, {\ttfamily import} and {\ttfamily export} declarations can only appear at a program\textquotesingle{}s top level. Setting this option to {\ttfamily true} allows them anywhere where a statement is allowed, and also allows {\ttfamily import.\+meta} expressions to appear in scripts (when {\ttfamily source\+Type} is not {\ttfamily \char`\"{}module\char`\"{}}).
\item {\bfseries{allow\+Await\+Outside\+Function}}\+: If {\ttfamily false}, {\ttfamily await} expressions can only appear inside {\ttfamily async} functions. Defaults to {\ttfamily true} for {\ttfamily ecma\+Version} 2022 and later, {\ttfamily false} for lower versions. Setting this option to {\ttfamily true} allows to have top-\/level {\ttfamily await} expressions. They are still not allowed in non-\/{\ttfamily async} functions, though.
...
\item {\bfseries{program}}\+: It is possible to parse multiple files into a single AST by passing the tree produced by parsing the first file as the {\ttfamily program} option in subsequent parses. This will add the toplevel forms of the parsed file to the \char`\"{}\+Program\char`\"{} (top) node of an existing parse tree.
...
{\bfseries{get\+Line\+Info}}{\ttfamily (input, offset)} can be used to get a {\ttfamily \{line, column\}} object for a given program string and offset.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1748}{}\doxysubsection{The $<$tt$>$\+Parser$<$/tt$>$ class}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1748}
...
The {\ttfamily extend} method takes any number of plugin values, and returns a new {\ttfamily Parser} class that includes the extra parser logic provided by the plugins.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1749}{}\doxysection{Command line interface}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1749}
...
\begin{DoxyItemize}
\item {\ttfamily -\/-\/ecma3$\vert$-\/-\/ecma5$\vert$-\/-\/ecma6$\vert$-\/-\/ecma7$\vert$-\/-\/ecma8$\vert$-\/-\/ecma9$\vert$-\/-\/ecma10}\+: Sets the ECMAScript version to parse. Default is version 9.
...
The utility spits out the syntax tree as JSON data.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1750}{}\doxysection{Existing plugins}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_acorn__r_e_a_d_m_e_autotoc_md1750}
