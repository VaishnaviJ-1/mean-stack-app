...
Designed with \href{http://nodejs.org/}{\texttt{ node}} in mind, but should work fine in the browser or other Common\+JS implementations.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12556}{}\doxysection{What This Is}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12556}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12557}{}\doxysection{What This Is (probably) Not}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12557}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12558}{}\doxysection{Regarding $<$tt$>$$<$!\+DOCTYPE$<$/tt$>$s and $<$tt$>$$<$!\+ENTITY$<$/tt$>$s}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12558}
The parser will handle the basic XML entities in text nodes and attribute values\+: {\ttfamily \& \texorpdfstring{$<$}{<} \texorpdfstring{$>$}{>} \textquotesingle{} "{}}. It\textquotesingle{}s possible to define additional entities in XML by putting them in the DTD. This parser doesn\textquotesingle{}t do anything with that. If you want to listen to the {\ttfamily ondoctype} event, and then fetch the doctypes, and read the entities and add them to {\ttfamily parser.\+ENTITIES}, then be my guest.

Unknown entities will fail in strict mode, and in loose mode, will pass through unmolested.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12559}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12559}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12560}{}\doxysection{Arguments}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12560}
...
\item {\ttfamily strict\+Entities} -\/ Boolean. If true, only parse \href{http://www.w3.org/TR/REC-xml/\#sec-predefined-ent}{\texttt{ predefined XML entities}} ({\ttfamily \&}, {\ttfamily \textquotesingle{}}, {\ttfamily \texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}}, and {\ttfamily "{}})
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12561}{}\doxysection{Methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12561}
...
{\ttfamily resume} -\/ To gracefully handle errors, assign a listener to the {\ttfamily error} event. Then, when the error is taken care of, you can call {\ttfamily resume} to continue parsing. Otherwise, the parser will not continue while in an error state.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12562}{}\doxysection{Members}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12562}
...
And a bunch of other stuff that you probably shouldn\textquotesingle{}t touch.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12563}{}\doxysection{Events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12563}
...
{\ttfamily processinginstruction} -\/ Stuff like {\ttfamily \texorpdfstring{$<$}{<}?xml foo=\char`\"{}blerg\char`\"{} ?\texorpdfstring{$>$}{>}}. Argument\+: object with {\ttfamily name} and {\ttfamily body} members. Attributes are not parsed, as processing instructions have implementation dependent semantics.
...
{\ttfamily noscript} -\/ In non-\/strict mode, {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tags trigger a {\ttfamily \char`\"{}script\char`\"{}} event, and their contents are not checked for special xml characters. If you pass {\ttfamily noscript\+: true}, then this behavior is suppressed.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12564}{}\doxysection{Reporting Problems}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_sax__r_e_a_d_m_e_autotoc_md12564}
