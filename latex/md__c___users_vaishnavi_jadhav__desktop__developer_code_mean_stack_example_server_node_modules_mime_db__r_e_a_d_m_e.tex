...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17976}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17976}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install mime-\/db}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17977}{}\doxysubsection{Database Download}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17977}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17978}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17978}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17979}{}\doxysection{Data Structure}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17979}
...
If unknown, every property could be {\ttfamily undefined}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17980}{}\doxysection{Contributing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17980}
...
To update the build, run {\ttfamily npm run build}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17981}{}\doxysubsection{Adding Custom Media Types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_mime_db__r_e_a_d_m_e_autotoc_md17981}
