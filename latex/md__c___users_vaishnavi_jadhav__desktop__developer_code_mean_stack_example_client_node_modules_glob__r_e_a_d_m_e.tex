...
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5871}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5871}
Install with npm
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5872}{}\doxysection{Glob Primer}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5872}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5873}{}\doxysubsection{Dots}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5873}
...
You can make glob treat dots as normal characters by setting {\ttfamily dot\+:true} in the options.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5874}{}\doxysubsection{Basename Matching}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5874}
If you set {\ttfamily match\+Base\+:true} in the options, and the pattern has no slashes in it, then it will seek for any file anywhere in the tree with a matching basename. For example, {\ttfamily $\ast$.js} would match {\ttfamily test/simple/basic.\+js}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5875}{}\doxysubsection{Empty Sets}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5875}
...
a*s*d*f
\end{DoxyVerb}
 To get the bash-\/style behavior, set the {\ttfamily nonull\+:true} in the options.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5876}{}\doxysubsection{See Also\+:}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5876}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5877}{}\doxysection{glob.\+has\+Magic(pattern, \mbox{[}options\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5877}
Returns {\ttfamily true} if there are any special characters in the pattern, and {\ttfamily false} otherwise.

Note that the options affect the results. If {\ttfamily noext\+:true} is set in the options object, then {\ttfamily +(a$\vert$b)} will not be considered a magic pattern. If the pattern has a brace expansion, like {\ttfamily a/\{b/c,x/y\}} then that is considered magical, unless {\ttfamily nobrace\+:true} is set in the options.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5878}{}\doxysection{glob(pattern, \mbox{[}options\mbox{]}, cb)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5878}
...
Perform an asynchronous glob search.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5879}{}\doxysection{glob.\+sync(pattern, \mbox{[}options\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5879}
...
Perform a synchronous glob search.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5880}{}\doxysection{Class\+: glob.\+Glob}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5880}
...
It\textquotesingle{}s an Event\+Emitter, and starts walking the filesystem to find matches immediately.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5881}{}\doxysubsection{new glob.\+Glob(pattern, \mbox{[}options\mbox{]}, \mbox{[}cb\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5881}
...
Note that if the {\ttfamily sync} flag is set in the options, then matches will be immediately available on the {\ttfamily g.\+found} member.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5882}{}\doxysubsection{Properties}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5882}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5883}{}\doxysubsection{Events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5883}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5884}{}\doxysubsection{Methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5884}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5885}{}\doxysubsection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5885}
...
\item {\ttfamily fs} File-\/system object with Node\textquotesingle{}s {\ttfamily fs} API. By default, the built-\/in {\ttfamily fs} module will be used. Set to a volume provided by a library like {\ttfamily memfs} to avoid using the \char`\"{}real\char`\"{} file-\/system.
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5886}{}\doxysection{Comparisons to other fnmatch/glob implementations}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5886}
...
If brace expansion is not disabled, then it is performed before any other interpretation of the glob pattern. Thus, a pattern like {\ttfamily +(a$\vert$\{b),c)\}}, which would not be valid in bash or zsh, is expanded {\bfseries{first}} into the set of {\ttfamily +(a$\vert$b)} and {\ttfamily +(a$\vert$c)}, and those patterns are checked for validity. Since those two are valid, matching proceeds.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5887}{}\doxysubsection{Comments and Negation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5887}
...
To specify things that should not match, use the {\ttfamily ignore} option.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5888}{}\doxysection{Windows}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5888}
...
Results from absolute patterns such as {\ttfamily /foo/$\ast$} are mounted onto the root setting using {\ttfamily path.\+join}. On windows, this will by default result in {\ttfamily /foo/$\ast$} matching {\ttfamily C\+:\textbackslash{}foo\textbackslash{}bar.\+txt}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5889}{}\doxysection{Race Conditions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5889}
...
Users are thus advised not to use a glob result as a guarantee of filesystem state in the face of rapid changes. For the vast majority of operations, this is never a problem.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5890}{}\doxysection{Glob Logo}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_glob__r_e_a_d_m_e_autotoc_md5890}
