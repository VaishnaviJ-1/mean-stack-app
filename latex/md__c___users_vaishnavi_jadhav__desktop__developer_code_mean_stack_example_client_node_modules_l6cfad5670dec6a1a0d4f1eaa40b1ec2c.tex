\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_l6cfad5670dec6a1a0d4f1eaa40b1ec2c_autotoc_md7980}{}\doxysection{Basic Setup}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_l6cfad5670dec6a1a0d4f1eaa40b1ec2c_autotoc_md7980}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_l6cfad5670dec6a1a0d4f1eaa40b1ec2c_autotoc_md7981}{}\doxysection{Configuration}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_l6cfad5670dec6a1a0d4f1eaa40b1ec2c_autotoc_md7981}

\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily stats}$\ast$$\ast$ -\/ toggle warnings and errors on/off (default\+: report warnings and errors)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily license\+Inclusion\+Test}$\ast$$\ast$ -\/ filter which licenses get included in the report (default\+: capture all licenses)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily output\+Filename}$\ast$$\ast$ -\/ customize the license report filename (default\+: `'\mbox{[}name\mbox{]}.licenses.\+txt\textquotesingle{}\`{})
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily unacceptable\+License\+Test}$\ast$$\ast$ -\/ error out on unacceptable license (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily handle\+Unacceptable\+License}$\ast$$\ast$ -\/ do something when an unacceptable license is found (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily excluded\+Package\+Test}$\ast$$\ast$ -\/ exclude packages (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily per\+Chunk\+Output}$\ast$$\ast$ -\/ control whether or not the license files are generated per chunk or are combined into one file (default\+: {\ttfamily true})
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily add\+Banner}$\ast$$\ast$ -\/ write a banner to the top of each js file (default\+: {\ttfamily false})
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily license\+Type\+Overrides}$\ast$$\ast$ -\/ override the license type for specific packages (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily license\+Text\+Overrides}$\ast$$\ast$ -\/ override the license text for specific packages (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily license\+File\+Overrides}$\ast$$\ast$ -\/ override the license filename for specific packages (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily render\+Licenses}$\ast$$\ast$ -\/ change the format / contents of the generated license file (default\+: print package name, license type, and license text)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily render\+Banner}$\ast$$\ast$ -\/ change the format / contents of the banner written to the top of each js file (default\+: print message indicating license filename)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily handle\+Missing\+License\+Text}$\ast$$\ast$ -\/ do something when license text is missing from a package (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily license\+Template\+Dir}$\ast$$\ast$ -\/ use fallback license files for when a package is missing a license file (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily chunk\+Include\+Exclude\+Test}$\ast$$\ast$ -\/ control which chunks gets processed by the plugin (default\+: all chunks get processed)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily modules\+Directories}$\ast$$\ast$ -\/ limit which directories get scanned for license files (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily additional\+Chunk\+Modules}$\ast$$\ast$ -\/ add additional node modules to a chunk (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily additional\+Modules}$\ast$$\ast$ -\/ add additional node modules to the scan (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily preferred\+License\+Types}$\ast$$\ast$ -\/ help the plugin decide which license type to pick in case a package specifies multiple licenses (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily handle\+License\+Ambiguity}$\ast$$\ast$ -\/ do something when the plugin finds ambiguous license types (default\+: pick first license type)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily handle\+Missing\+License\+Type}$\ast$$\ast$ -\/ do something when a package is missing a license type (default\+: disabled)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item $\ast$$\ast${\ttfamily skip\+Child\+Compilers}$\ast$$\ast$ -\/ do not apply the plugin to child webpack compilers (default\+: applies to child compilers too)
\end{DoxyItemize}
