...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8561}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8561}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install mime-\/db}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8562}{}\doxysubsection{Database Download}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8562}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8563}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8563}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8564}{}\doxysection{Data Structure}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8564}
...
If unknown, every property could be {\ttfamily undefined}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8565}{}\doxysection{Contributing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8565}
...
To update the build, run {\ttfamily npm run build}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8566}{}\doxysubsection{Adding Custom Media Types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_mime_db__r_e_a_d_m_e_autotoc_md8566}
