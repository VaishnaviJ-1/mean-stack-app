...
The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5916}{}\doxysection{Improvements over $<$a href=\char`\"{}https\+://nodejs.\+org/api/fs.\+html\char`\"{} $>$fs module$<$/a$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5916}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily EACCESS} or {\ttfamily EPERM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5917}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5917}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5918}{}\doxysection{Sync methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5918}
...
This is a known limitation, not a bug.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5919}{}\doxysection{Global Patching}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5919}
...
This should only ever be done at the top-\/level application layer, in order to delay on EMFILE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5920}{}\doxysection{Changes}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5920}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of Node from 0.\+8 through 7.\+0.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5921}{}\doxysubsection{v4}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5921}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5922}{}\doxysubsection{v3}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5922}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5923}{}\doxysubsection{v2.\+1.\+0}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5923}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5924}{}\doxysubsection{v2.\+0}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5924}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5925}{}\doxysubsection{v1.\+1}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5925}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5926}{}\doxysubsection{1.\+0}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_graceful_fs__r_e_a_d_m_e_autotoc_md5926}
