...
This ensures that when Open\+SSL is statically linked into {\ttfamily node} then, the bundled Open\+SSL headers are included, but when the system Open\+SSL is in use, then only those headers will be used.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_na2e1619071859241a103217558022748_autotoc_md9275}{}\doxysubsection{Windows?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_na2e1619071859241a103217558022748_autotoc_md9275}
...
In the meantime, one possible solution is using another copy of Open\+SSL, which is what \href{https://github.com/ncb000gt/node.bcrypt.js}{\texttt{ {\ttfamily node-\/bcrypt}}} currently does. Adding something like this to your {\ttfamily binding.\+gyp} file\textquotesingle{}s {\ttfamily \char`\"{}conditions\char`\"{}} block would enable this\+:
