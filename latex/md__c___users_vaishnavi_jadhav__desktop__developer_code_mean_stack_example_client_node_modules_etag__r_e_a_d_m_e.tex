...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4784}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4784}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4785}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4785}

\begin{DoxyCode}{0}
\DoxyCodeLine{var etag = require('etag')}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4786}{}\doxysubsection{etag(entity, \mbox{[}options\mbox{]})}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4786}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4787}{}\doxysubsubsection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4787}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4788}{}\doxyparagraph{weak}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4788}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4789}{}\doxysection{Testing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4789}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4790}{}\doxysection{Benchmark}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4790}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4791}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_etag__r_e_a_d_m_e_autotoc_md4791}
