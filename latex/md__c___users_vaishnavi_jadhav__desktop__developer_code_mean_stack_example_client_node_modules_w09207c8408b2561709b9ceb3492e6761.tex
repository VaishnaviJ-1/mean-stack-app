...
{\ttfamily websocket-\/extensions} provides a container for registering extension plugins, and provides all the functions required to negotiate which extensions to use during a session via the {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} header. By implementing the APIs defined in this document, an extension may be used by any Web\+Socket library based on this framework.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15790}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15790}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install websocket-\/extensions}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15791}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15791}
...
The library is designed with the aim that any protocol implementation and any extension can be used together, so long as they support the same abstract representation of frames and messages.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15792}{}\doxysubsection{Data types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15792}
The APIs provided by the framework rely on two data types; extensions will expect to be given data and to be able to return data in these formats\+:\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15793}{}\doxysubsubsection{$<$em$>$\+Frame$<$/em$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15793}
...
\end{longtabu}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15794}{}\doxysubsubsection{$<$em$>$\+Message$<$/em$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15794}
...
\end{longtabu}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15795}{}\doxysubsection{For driver authors}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15795}
...
In the following examples, {\ttfamily exts} refers to this {\ttfamily Extensions} instance.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15796}{}\doxysubsubsection{Client sessions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15796}
...
This returns a string, for example {\ttfamily \char`\"{}permessage-\/deflate; client\+\_\+max\+\_\+window\+\_\+bits\char`\"{}}, that represents all the extensions the client is offering to use, and their parameters. This string may contain multiple offers for the same extension.
...
If the server has sent any extension responses that the client does not recognize, or are in conflict with one another for use of RSV bits, or that use invalid parameters for the named extensions, then {\ttfamily exts.\+activate()} will {\ttfamily throw}. In this event, the client driver should fail the connection with closing code {\ttfamily 1010}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15797}{}\doxysubsubsection{Server sessions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15797}
...
Calling {\ttfamily exts.\+generate\+Response(header)} activates those extensions the client has asked to use, if they are registered, asks each extension for a set of response parameters, and returns a string containing the response parameters for all accepted extensions.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15798}{}\doxysubsubsection{In both directions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15798}
...
The callback is invoked when all extensions have finished processing any messages in the pipeline and it\textquotesingle{}s safe to close the socket.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15799}{}\doxysubsection{For extension authors}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15799}
...
The extension must decide which set of parameters it wants to accept, if any, and return a {\itshape Server\+Session} if it wants to accept the parameters and {\ttfamily null} otherwise.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15800}{}\doxysubsubsection{$<$em$>$\+Client\+Session$<$/em$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15800}
...
This returns the set of parameters the server session wants to send in its {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} response header. Only one set of parameters is returned to the client per extension. Server sessions that would confict on their use of RSV bits are not activated.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15802}{}\doxysubsubsection{$<$em$>$\+Session$<$/em$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15802}
...
The framework will call this method when the Web\+Socket session ends, allowing the session to release any resources it\textquotesingle{}s using.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15803}{}\doxysection{Examples}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_w09207c8408b2561709b9ceb3492e6761_autotoc_md15803}
