...
\begin{DoxyItemize}
\item Node\textquotesingle{}s {\ttfamily fs} API implemented, see \+\_\+\+API Status\+\_\+
\item Stores files in memory, in {\ttfamily Buffer}s
\item Throws sameish$\ast$ errors as Node.\+js
...
\item Permissions may$\ast$ be implemented in the future
\item Can be used in browser, see \href{https://github.com/streamich/memfs-webpack}{\texttt{ {\ttfamily memfs-\/webpack}}}
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8387}{}\doxysubsection{Install}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8387}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install -\/-\/save memfs}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8388}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8388}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8389}{}\doxysection{Docs}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8389}
...
\item API status
\item Dependencies
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8390}{}\doxysection{See also}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8390}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8391}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_memfs__r_e_a_d_m_e_autotoc_md8391}
