...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14348}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14348}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install -\/-\/save tapable}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14349}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14349}
...
This ensures fastest possible execution.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14350}{}\doxysection{Hook types}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14350}
...
The hook type is reflected in its class name. E.\+g., {\ttfamily Async\+Series\+Waterfall\+Hook} allows asynchronous functions and runs them in series, passing each function’s return value into the next function.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14351}{}\doxysection{Interception}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14351}
...
{\bfseries{register}}\+: {\ttfamily (tap\+: Tap) =\texorpdfstring{$>$}{>} Tap $\vert$ undefined} Adding {\ttfamily register} to your interceptor will trigger for each added {\ttfamily Tap} and allows to modify it.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14352}{}\doxysection{Context}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14352}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14353}{}\doxysection{Hook\+Map}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14353}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14354}{}\doxysection{Hook/\+Hook\+Map interface}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14354}
Public\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14355}{}\doxysection{Multi\+Hook}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_tapable__r_e_a_d_m_e_autotoc_md14355}
