...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9333}{}\doxysection{node-\/gyp v7}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9333}
...
Where \char`\"{}path to node-\/gyp\char`\"{} is to the {\ttfamily node-\/gyp} executable which may be a symlink in your global bin directory (e.\+g. {\ttfamily /usr/local/bin/node-\/gyp}), or a path to the {\ttfamily node-\/gyp} installation directory and the {\ttfamily bin/node-\/gyp.\+js} file within it (e.\+g. {\ttfamily /usr/local/lib/node\+\_\+modules/node-\/gyp/bin/node-\/gyp.js}).

{\bfseries{If you use {\ttfamily npm config set} to change your global {\ttfamily node\+\_\+gyp} you are responsible for keeping it up to date and can\textquotesingle{}t rely on {\ttfamily npm} to give you a newer version when available.}} Use {\ttfamily npm config delete node\+\_\+gyp} to unset this configuration option.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9334}{}\doxysection{Fixing Catalina for older versions of $<$tt$>$node-\/gyp$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9334}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9335}{}\doxysubsection{Is my Mac running mac\+OS Catalina?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9335}
...
\end{DoxyCode}
 If {\ttfamily Product\+Version} is less then {\ttfamily 10.\+15} then this document is not for you. Normal install docs for {\ttfamily node-\/gyp} on mac\+OS can be found at \href{https://github.com/nodejs/node-gyp\#on-macos}{\texttt{ https\+://github.\+com/nodejs/node-\/gyp\#on-\/macos}}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9336}{}\doxysubsection{The acid test}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9336}
...
If test failed, there is a problem with your Xcode Command Line Tools installation. Continue to Solutions.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9337}{}\doxysubsection{Solutions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9337}
...
\begin{DoxyEnumerate}
\item With the full Xcode ($\sim$7.6 GB download) from the {\ttfamily App Store} app.
...
\end{DoxyEnumerate}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9338}{}\doxysubsection{Installing $<$tt$>$node-\/gyp$<$/tt$>$ using the full Xcode}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9338}
...
\begin{DoxyItemize}
\item If Xcode or Tools upgrades are listed, use \char`\"{}\+Software Upgrade\char`\"{} to install them.
\end{DoxyItemize}
...
\end{DoxyEnumerate}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9339}{}\doxysubsection{Installing $<$tt$>$node-\/gyp$<$/tt$>$ using the Xcode Command Line Tools via $<$tt$>$xcode-\/select -\/-\/install$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9339}

\begin{DoxyEnumerate}
\item If the {\itshape acid test} has not succeeded, then try {\ttfamily xcode-\/select -\/-\/install}
\item If the installation command returns {\ttfamily xcode-\/select\+: error\+: command line tools are already installed, use \char`\"{}\+Software Update\char`\"{} to install updates}, continue to remove and reinstall
\item Wait until the install process is {\itshape complete}.
\item {\ttfamily softwareupdate -\/l} \# No listing is a good sign.
\begin{DoxyItemize}
\item If Xcode or Tools upgrades are listed, use \char`\"{}\+Software Update\char`\"{} to install them.
\end{DoxyItemize}
\item {\ttfamily xcode-\/select -\/version} \# Should return {\ttfamily xcode-\/select version 2370} or later.
...
\end{DoxyEnumerate}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9340}{}\doxysubsection{Installing $<$tt$>$node-\/gyp$<$/tt$>$ using the Xcode Command Line Tools via manual download}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9340}

\begin{DoxyEnumerate}
\item Download the appropriate version of the \char`\"{}\+Command Line Tools for Xcode\char`\"{} for your version of Catalina from \href{https://developer.apple.com/download/more/}{\texttt{ https\+://developer.\+apple.\+com/download/more/}}. As of Mac\+OS 10.\+15.\+5, that\textquotesingle{}s \href{https://download.developer.apple.com/Developer_Tools/Command_Line_Tools_for_Xcode_11.5/Command_Line_Tools_for_Xcode_11.5.dmg}{\texttt{ Command\+\_\+\+Line\+\_\+\+Tools\+\_\+for\+\_\+\+Xcode\+\_\+11.\+5.\+dmg}}
\item Install the package.
\item Run the \+\_\+acid test\+\_\+ steps above.
\end{DoxyEnumerate}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9341}{}\doxysubsection{I did all that and the acid test still does not pass \+:-\/(}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_node_gyp_mac_o_s__catalina_autotoc_md9341}
