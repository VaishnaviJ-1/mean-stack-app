...
The complete solution for \href{http://nodejs.org}{\texttt{ node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{ commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{ API documentation}}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3187}{}\doxysection{Installation}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3187}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3188}{}\doxysection{Option parsing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3188}
...
{\bfseries{NOTE}}\+: If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3189}{}\doxysection{Version option}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3189}
...
The version flags can be named anything, but the long option is required.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3190}{}\doxysection{Command-\/specific options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3190}
...
A command\textquotesingle{}s options are validated when the command is used. Any unknown options will be reported as an error. However, if an action-\/based command does not define an action, then the options are not validated.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3191}{}\doxysection{Coercion}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3191}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3192}{}\doxysection{Regular Expression}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3192}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3193}{}\doxysection{Variadic arguments}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3193}
...
An {\ttfamily Array} is used for the value of a variadic argument. This applies to {\ttfamily program.\+args} as well as the argument passed to your action as demonstrated above.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3194}{}\doxysection{Specify the argument syntax}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3194}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}cmd\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \mbox{[}env\mbox{]}}) indicate optional input.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3195}{}\doxysection{Git-\/style sub-\/commands}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3195}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3196}{}\doxysubsection{$<$tt$>$-\/-\/harmony$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3196}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3197}{}\doxysection{Automated –help}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3197}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3198}{}\doxysection{Custom help}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3198}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3199}{}\doxysection{.\+output\+Help(cb)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3199}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3200}{}\doxysection{.\+help(cb)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3200}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3201}{}\doxysection{Custom event listeners}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3201}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3202}{}\doxysection{Examples}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3202}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3203}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_commander__readme_autotoc_md3203}
