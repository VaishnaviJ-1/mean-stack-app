...
\href{https://travis-ci.org/ajv-validator/ajv-formats}{\texttt{ }} \href{https://www.npmjs.com/package/ajv-formats}{\texttt{ }} \href{https://gitter.im/ajv-validator/ajv}{\texttt{ }} \href{https://github.com/sponsors/epoberezkin}{\texttt{ }}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1836}{}\doxysection{Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1836}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1837}{}\doxysection{Formats}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1837}
...
{\bfseries{Please note}}\+: JSON Schema draft-\/07 also defines formats {\ttfamily iri}, {\ttfamily iri-\/reference}, {\ttfamily idn-\/hostname} and {\ttfamily idn-\/email} for URLs, hostnames and emails with international characters. These formats are available in \href{https://github.com/luzlab/ajv-formats-draft2019}{\texttt{ ajv-\/formats-\/draft2019}} plugin.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1838}{}\doxysection{Keywords to compare values\+: $<$tt$>$format\+Maximum$<$/tt$>$ / $<$tt$>$format\+Minimum$<$/tt$>$ and $<$tt$>$format\+Exclusive\+Maximum$<$/tt$>$ / $<$tt$>$format\+Exclusive\+Minimum$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1838}
...
When these keyword are added, they also add comparison functions to formats {\ttfamily \char`\"{}date\char`\"{}}, {\ttfamily \char`\"{}time\char`\"{}} and {\ttfamily \char`\"{}date-\/time\char`\"{}}. User-\/defined formats also can have comparison functions. See \href{https://github.com/ajv-validator/ajv/blob/master/docs/api.md\#api-addformat}{\texttt{ add\+Format}} method.
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1839}{}\doxysection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1839}
...
\begin{DoxyEnumerate}
\item Format validation mode (default is {\ttfamily \char`\"{}full\char`\"{}}) with optional list of format names and {\ttfamily keywords} option to add additional format comparison keywords\+:
\end{DoxyEnumerate}
...
In {\ttfamily \char`\"{}fast\char`\"{}} mode the following formats are simplified\+: {\ttfamily \char`\"{}date\char`\"{}}, {\ttfamily \char`\"{}time\char`\"{}}, {\ttfamily \char`\"{}date-\/time\char`\"{}}, {\ttfamily \char`\"{}uri\char`\"{}}, {\ttfamily \char`\"{}uri-\/reference\char`\"{}}, {\ttfamily \char`\"{}email\char`\"{}}. For example {\ttfamily \char`\"{}date\char`\"{}}, {\ttfamily \char`\"{}time\char`\"{}} and {\ttfamily \char`\"{}date-\/time\char`\"{}} do not validate ranges in {\ttfamily \char`\"{}fast\char`\"{}} mode, only string structure, and other formats have simplified regular expressions.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1840}{}\doxysection{Tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1840}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1841}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_ajv_formats__r_e_a_d_m_e_autotoc_md1841}
