...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5629}{}\doxysection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5629}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5630}{}\doxysubsection{Global options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5630}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5631}{}\doxysubsection{Per-\/request options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5631}
...
\DoxyCodeLine{options.beforeRedirect = (options, \{ headers \}) => \{}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5632}{}\doxysubsection{Advanced usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5632}
...
Such custom protocols only need an implementation of the {\ttfamily request} method.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5633}{}\doxysection{Browser Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5633}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5634}{}\doxysection{Contributing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5634}
Pull Requests are always welcome. Please \href{https://github.com/follow-redirects/follow-redirects/issues}{\texttt{ file an issue}} detailing your proposal before you invest your valuable time. Additional features and bug fixes should be accompanied by tests. You can run the test suite locally with a simple {\ttfamily npm test} command.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5635}{}\doxysection{Debug Logging}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5635}
{\ttfamily follow-\/redirects} uses the excellent \href{https://www.npmjs.com/package/debug}{\texttt{ debug}} for logging. To turn on logging set the environment variable {\ttfamily DEBUG=follow-\/redirects} for debug output from just this module. When running the test suite it is sometimes advantageous to set {\ttfamily DEBUG=$\ast$} to see output from the express server as well.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5636}{}\doxysection{Authors}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5636}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5637}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_follow_redirects__r_e_a_d_m_e_autotoc_md5637}
