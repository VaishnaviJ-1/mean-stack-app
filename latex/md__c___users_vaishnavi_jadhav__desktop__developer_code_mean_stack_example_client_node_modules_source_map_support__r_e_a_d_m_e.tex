...
This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{ V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{ source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13748}{}\doxysection{Installation and Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13748}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13749}{}\doxysubsubsection{Node support}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13749}
...
From here you have two options.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13750}{}\doxyparagraph{CLI Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13750}

\begin{DoxyCode}{0}
\DoxyCodeLine{node -\/r source-\/map-\/support/register compiled.js}

\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13751}{}\doxyparagraph{Programmatic Usage}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13751}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13752}{}\doxysubsubsection{Browser support}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13752}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13753}{}\doxysection{Options}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13753}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13754}{}\doxysection{Demos}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13754}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13755}{}\doxysubsubsection{Basic Demo}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13755}
original.\+js\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13756}{}\doxysubsubsection{Type\+Script Demo}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13756}
demo.\+ts\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13757}{}\doxysubsubsection{Coffee\+Script Demo}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13757}
demo.\+coffee\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13758}{}\doxysection{Tests}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13758}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13759}{}\doxysection{License}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_source_map_support__r_e_a_d_m_e_autotoc_md13759}
