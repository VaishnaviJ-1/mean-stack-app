\href{https://travis-ci.org/HdrHistogram/HdrHistogramJS}{\texttt{ }}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5965}{}\doxysection{Hdr\+Histogram\+JS}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5965}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5966}{}\doxysection{Dataviz}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5966}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5967}{}\doxysection{Getting started}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5967}
...
Then you will have access to classes and functions of the APIs using \char`\"{}hdr\char`\"{} prefix.
...
Note for Type\+Script developers\+: since Hdr\+Histogram\+JS has been written in Type\+Script, definition files are embedded, no additional task is needed to get them.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5968}{}\doxysection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5968}
The examples below use ES6 syntax. You can check out demo sources for examples on how to use Hdr\+Histogram directly within a browser, you should not have any surprise though.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5969}{}\doxysubsection{Instantiate an histogram}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5969}
...
Bit\+Bucket\+Size \textquotesingle{}packed\textquotesingle{} options is available since Hdr\+Histogram\+JS v1.\+2 . Like the Java packed implementation, it has a very low memory footprint but it is way slower than regular bucket based implementation.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5970}{}\doxysubsection{Record values and retrieve metrics}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5970}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5971}{}\doxysubsection{Dealing with coordinated omissions}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5971}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5972}{}\doxysubsection{Boosting performances with Web\+Assembly}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5972}
...
Note\+: If you want to use this feature on the browser side, along with the UMD package, you need to add external dependency \char`\"{}pako\char`\"{}. \char`\"{}pako\char`\"{} is mandatory to bootstrap the WASM module which is compressed to save some weight.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5973}{}\doxysubsection{Encode \& decode}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5973}
...
If you want to use this feature along with the UMD package, you need to add external dependency \char`\"{}pako\char`\"{}. \char`\"{}pako\char`\"{} is used for zlib compression. Using npm you should get it as a transitive dependency, otherwise you need to add it in your html page.
...
You can check out \href{https://hdrhistogram.github.io/HdrHistogramJSDemo/decoding-demo.html}{\texttt{ this demo}} or this \href{https://hdrhistogram.github.io/HdrHistogramJSDemo/plotFiles.html}{\texttt{ plotter on steroid}} to see this feature live! ~\newline
 {\itshape Be aware that only latest V2 encoding has been implemented, please raise a github issue if you need to see other versions implemented}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5974}{}\doxysubsection{Histogram logs}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5974}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5975}{}\doxysection{Performance tips}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5975}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5976}{}\doxysection{Tree Shaking}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5976}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5977}{}\doxysection{Migrating from v1 to v2}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5977}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5978}{}\doxysection{Design \& Limitations}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_hdr_histogram_js__r_e_a_d_m_e_autotoc_md5978}
...
Main limitations comes from number support in Java\+Script. There is no such thing as 64b integers in Java\+Script. Everything is \char`\"{}number\char`\"{}, and a number is safe as an integer up to 2$^\wedge$53. ~\newline
