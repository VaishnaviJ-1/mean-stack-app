...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9272}{}\doxysubsection{How to avoid (the short answer)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9272}
To avoid this error completely just use a stable release of node.\+js. i.\+e. {\ttfamily v0.\+10.\+4}, and {\bfseries{not}} {\ttfamily v0.\+10.\+4-\/pre}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9273}{}\doxysubsection{How to fix (the long answer)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9273}
This error happens because {\ttfamily node-\/gyp} does not know what header files were used to compile your \char`\"{}pre\char`\"{} version of node, and therefore it needs you to specify the node source code directory path using the {\ttfamily -\/-\/nodedir} flag.

For example, if I compiled my development (\char`\"{}pre\char`\"{}) version of node.\+js using the source code in {\ttfamily /\+Users/nrajlich/node}, then I could invoke {\ttfamily node-\/gyp} like\+:
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9274}{}\doxysubsubsection{Always use $<$tt$>$-\/-\/nodedir$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_nfb5ae8bacd9e99954d6d99716d1b30d0_autotoc_md9274}
