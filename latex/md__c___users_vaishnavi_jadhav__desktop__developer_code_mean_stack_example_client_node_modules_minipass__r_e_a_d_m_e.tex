...
There is also no {\ttfamily unpipe()} method. Once you start piping, there is no stopping it!
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8800}{}\doxysection{Differences from Node.\+js Streams}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8800}
There are several things that make Minipass streams different from (and in some ways superior to) Node.\+js core streams.

Please read these caveats if you are familiar with node-\/core streams and intend to use Minipass streams in your programs.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8801}{}\doxysubsection{Timing}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8801}
...
This non-\/deferring approach makes Minipass streams much easier to reason about, especially in the context of Promises and other flow-\/control mechanisms.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8802}{}\doxysubsection{No High/\+Low Water Marks}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8802}
...
If the data has nowhere to go, then {\ttfamily write()} returns false, and the data sits in a buffer, to be drained out immediately as soon as anyone consumes it.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8803}{}\doxysubsection{Hazards of Buffering (or\+: Why Minipass Is So Fast)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8803}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8804}{}\doxysubsection{Immediately emit $<$tt$>$end$<$/tt$>$ for empty streams (when not paused)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8804}
...
If you have logic that occurs on the {\ttfamily end} event which you don\textquotesingle{}t want to potentially happen immediately (for example, closing file descriptors, moving on to the next entry in an archive parse stream, etc.) then be sure to call {\ttfamily stream.\+pause()} on creation, and then {\ttfamily stream.\+resume()} once you are ready to respond to the {\ttfamily end} event.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8805}{}\doxysubsection{Emit $<$tt$>$end$<$/tt$>$ When Asked}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8805}
One hazard of immediately emitting `\textquotesingle{}end'\`{} is that you may not yet have had a chance to add a listener. In order to avoid this hazard, Minipass streams safely re-\/emit the `\textquotesingle{}end'{\ttfamily event if a new listener is added after }\textquotesingle{}end\textquotesingle{}\`{} has been emitted.
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8806}{}\doxysubsection{Impact of \char`\"{}immediate flow\char`\"{} on Tee-\/streams}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8806}
A \char`\"{}tee stream\char`\"{} is a stream piping to multiple destinations\+:
...
The solution is to create a dedicated tee-\/stream junction that pipes to both locations, and then pipe to {\itshape that} instead.
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8807}{}\doxysection{USAGE}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8807}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8808}{}\doxysubsection{OPTIONS}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8808}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8809}{}\doxysubsection{API}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8809}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8810}{}\doxysubsection{Methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8810}

\begin{DoxyItemize}
\item {\ttfamily write(chunk, \mbox{[}encoding\mbox{]}, \mbox{[}callback\mbox{]})} -\/ Put data in. (Note that, in the base Minipass class, the same data will come out.) Returns {\ttfamily false} if the stream will buffer the next write, or true if it\textquotesingle{}s still in \char`\"{}flowing\char`\"{} mode.
...
\item {\ttfamily pipe(dest)} -\/ Send all output to the stream provided. There is no way to unpipe. When data is emitted, it is immediately written to any and all pipe destinations.
\item {\ttfamily on(ev, fn)}, {\ttfamily emit(ev, fn)} -\/ Minipass streams are Event\+Emitters. Some events are given special treatment, however. (See below under \char`\"{}events\char`\"{}.)
\item {\ttfamily promise()} -\/ Returns a Promise that resolves when the stream emits {\ttfamily end}, or rejects if the stream emits {\ttfamily error}.
\item {\ttfamily collect()} -\/ Return a Promise that resolves on {\ttfamily end} with an array containing each chunk of data that was emitted, or rejects if the stream emits {\ttfamily error}. Note that this consumes the stream data.
\item {\ttfamily concat()} -\/ Same as {\ttfamily collect()}, but concatenates the data into a single Buffer object. Will reject the returned promise if the stream is in object\+Mode, or if it goes into object\+Mode by the end of the data.
\item {\ttfamily read(n)} -\/ Consume {\ttfamily n} bytes of data out of the buffer. If {\ttfamily n} is not provided, then consume all of it. If {\ttfamily n} bytes are not available, then it returns null. {\bfseries{Note}} consuming streams in this way is less efficient, and can lead to unnecessary Buffer copying.
\item {\ttfamily destroy(\mbox{[}er\mbox{]})} -\/ Destroy the stream. If an error is provided, then an `\textquotesingle{}error'{\ttfamily event is emitted. If the stream has a}close(){\ttfamily method, and has not emitted a}\textquotesingle{}close\textquotesingle{}{\ttfamily event yet, then}stream.\+close(){\ttfamily will be called. Any Promises returned by}.promise(){\ttfamily ,}.collect(){\ttfamily or }.concat()\`{} will be rejected. After being destroyed, writing to the stream will emit an error. No more data will be emitted if the stream is destroyed, even if it was previously buffered.
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8811}{}\doxysubsection{Properties}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8811}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8812}{}\doxysubsection{Events}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8812}
...
\item {\ttfamily prefinish} An end-\/ish event that follows the same logic as {\ttfamily end} and is emitted in the same conditions where {\ttfamily end} is emitted. Emitted after `\textquotesingle{}end'{\ttfamily . $\ast$}finish{\ttfamily An end-\/ish event that follows the same logic as}end{\ttfamily and is emitted in the same conditions where}end{\ttfamily is emitted. Emitted after }\textquotesingle{}prefinish\textquotesingle{}{\ttfamily . $\ast$}close{\ttfamily An indication that an underlying resource has been released. Minipass does not emit this event, but will defer it until after}end\`{} has been emitted, since it throws off some stream libraries otherwise.
\item {\ttfamily drain} Emitted when the internal buffer empties, and it is again suitable to {\ttfamily write()} into the stream.
\item {\ttfamily readable} Emitted when data is buffered and ready to be read by a consumer.
\item {\ttfamily resume} Emitted when stream changes state from buffering to flowing mode. (Ie, when {\ttfamily resume} is called, {\ttfamily pipe} is called, or a {\ttfamily data} event listener is added.)
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8813}{}\doxysubsection{Static Methods}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8813}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8814}{}\doxysection{EXAMPLES}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8814}
Here are some examples of things you can do with Minipass streams.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8815}{}\doxysubsection{simple \char`\"{}are you done yet\char`\"{} promise}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8815}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8816}{}\doxysubsection{collecting}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8816}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8817}{}\doxysubsection{collecting into a single blob}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8817}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8818}{}\doxysubsection{iteration}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8818}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8819}{}\doxysubsection{subclass that $<$tt$>$console.\+log()$<$/tt$>$s everything written into it}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8819}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8820}{}\doxysubsection{same thing, but using an inline anonymous class}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8820}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8821}{}\doxysubsection{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8821}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8822}{}\doxysubsection{transform that creates newline-\/delimited JSON}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8822}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8823}{}\doxysubsection{transform that parses newline-\/delimited JSON}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_minipass__r_e_a_d_m_e_autotoc_md8823}
