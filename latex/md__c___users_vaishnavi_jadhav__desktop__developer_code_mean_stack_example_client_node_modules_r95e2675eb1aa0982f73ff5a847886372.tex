...
\item Read and understand the detail on \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r8d6c8c95b79aea044d75b013c67ce33c}{how the loader works}}.
...
I\textquotesingle{}m happy this loader helps so many people. Open-\/source is provided as-\/is and I\textquotesingle{}m currently {\bfseries{not}} \href{https://en.wikipedia.org/wiki/Eating_your_own_dog_food}{\texttt{ dogfooding}} this loader in my own work, so please try not project your frustrations. There are some really great people who follow this project who can help.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11882}{}\doxysection{Known issues}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11882}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11883}{}\doxysubsection{Support for $<$tt$>$image-\/set()$<$/tt$>$}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11883}
Right now this loader only rewrites {\ttfamily url()} statements.

If you need other statements processed, such as {\ttfamily image-\/set()}, then please upvote \href{issues/119}{\texttt{ issue \#119}}.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11884}{}\doxysubsection{Absolute URIs}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11884}
By \char`\"{}absolute URIs\char`\"{} we more correctly mean assets with root-\/relative URLs or absolute file paths. These paths are {\bfseries{not}} processed unless a {\ttfamily root} is specified.
...
Also it be useful to process absolute URIs if you have a custom {\ttfamily join} function and want to process all the paths. Although this is perhaps better done with some separate {\ttfamily postcss} plugin.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11885}{}\doxysubsection{Windows line breaks}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_r95e2675eb1aa0982f73ff5a847886372_autotoc_md11885}
