...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_overview}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18467}{}\doxysection{Overview}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18467}
...
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18468}{}\doxysubsection{Finding problematic bits of code using grep}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18468}
Just run `grep -\/nrE '\mbox{[}$^\wedge$a-\/z\+A-\/Z\mbox{]}(Slow)?Buffer\textbackslash{}s$\ast$(\textquotesingle{} --exclude-\/dir node\+\_\+modules\`{}.

It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18469}{}\doxysubsection{Finding problematic bits of code using Node.\+js 8}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18469}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18470}{}\doxysubsection{Finding problematic bits of code using linters}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18470}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-1}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18471}{}\doxysection{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18471}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-2}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18472}{}\doxysection{Variant 2\+: Use a polyfill}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18472}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-3}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18473}{}\doxysection{Variant 3 — manual detection, with safeguards}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18473}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18474}{}\doxysubsection{Buffer(0)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18474}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18475}{}\doxysubsection{Buffer(not\+Number)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18475}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18476}{}\doxysubsection{Buffer(number)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18476}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18477}{}\doxysection{Regarding Buffer.\+alloc\+Unsafe}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18477}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_faq}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18478}{}\doxysection{FAQ}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18478}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_design-flaws}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18479}{}\doxysubsection{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18479}
...
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_ecosystem-usage}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18480}{}\doxysubsection{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_autotoc_md18480}
