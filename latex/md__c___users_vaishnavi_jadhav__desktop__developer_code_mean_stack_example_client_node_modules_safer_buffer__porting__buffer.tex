\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_overview}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_overview}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12504}{}\doxysection{Overview}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12504}

\begin{DoxyItemize}
\item \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-1}{Variant 1\+: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.}} ({\itshape recommended})
\item \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-2}{Variant 2\+: Use a polyfill}}
\item \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-3}{Variant 3\+: manual detection, with safeguards}}
\end{DoxyItemize}\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12505}{}\doxysubsection{Finding problematic bits of code using grep}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12505}
Just run `grep -\/nrE '\mbox{[}$^\wedge$a-\/z\+A-\/Z\mbox{]}(Slow)?Buffer\textbackslash{}s$\ast$(\textquotesingle{} --exclude-\/dir node\+\_\+modules\`{}.

It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12506}{}\doxysubsection{Finding problematic bits of code using Node.\+js 8}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12506}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12507}{}\doxysubsection{Finding problematic bits of code using linters}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12507}
...
\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-1}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-1}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12508}{}\doxysection{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12508}
...
{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-2}{Variant 2}} or \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-3}{Variant 3}} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer API usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-2}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-2}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12509}{}\doxysection{Variant 2\+: Use a polyfill}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12509}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \mbox{\hyperlink{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-1}{Variant 1}}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-3}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_variant-3}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12510}{}\doxysection{Variant 3 — manual detection, with safeguards}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12510}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12511}{}\doxysubsection{Buffer(0)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12511}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12512}{}\doxysubsection{Buffer(not\+Number)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12512}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12513}{}\doxysubsection{Buffer(number)}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12513}
...
\end{DoxyCode}
\hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12514}{}\doxysection{Regarding Buffer.\+alloc\+Unsafe}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12514}
...
\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_faq}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_faq}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12515}{}\doxysection{FAQ}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12515}
\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_design-flaws}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_design-flaws}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12516}{}\doxysubsection{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12516}
...
\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_ecosystem-usage}%
\Hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_server_node_modules_safer_buffer__porting__buffer_ecosystem-usage}%
 \hypertarget{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12517}{}\doxysubsection{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}\label{md__c___users_vaishnavi_jadhav__desktop__developer_code_mean_stack_example_client_node_modules_safer_buffer__porting__buffer_autotoc_md12517}
